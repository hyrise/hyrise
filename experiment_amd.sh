...
do
    ...
    do
	    ...
	    ninja -C ${build_dir} hyriseBenchmarkTPCH > /dev/null
            ...
            numactl -m 0 -N 0 ./${build_dir}/hyriseBenchmarkTPCH --scheduler --clients 48 --cores 64 -s ${scale_factor} --mode=Shuffled --time ${runtime} -o sleeptimeanalysis_${MIN_SLEEPTIME}_${MAX_SLEEPTIME}_${LOOP_TIME}.json
        done
    done
done
