...
def plot_tpcds_scatter(data_dir: Path) -> Path:
	...
	fig, axes = plt.subplots(2, 2, figsize=(6.2, 5.5), dpi=200)

	_plot_subplot(
		axes[0, 0],
		data_dir / "master_tpcds_s1_st.json",
		data_dir / "reduce_tpcds_s1_st.json",
		"(a) SF 1, ST",
	)
	_plot_subplot(
		axes[0, 1],
		data_dir / "master_tpcds_s1_mt.json",
		data_dir / "reduce_tpcds_s1_mt.json",
		"(b) SF 1, MT",
	)
	_plot_subplot(
		axes[1, 0],
		data_dir / "master_tpcds_s10_st.json",
		data_dir / "reduce_tpcds_s10_st.json",
		"(c) SF 10, ST",
	)
	_plot_subplot(
		axes[1, 1],
		data_dir / "master_tpcds_s10_mt.json",
		data_dir / "reduce_tpcds_s10_mt.json",
		"(d) SF 10, MT",
	)
