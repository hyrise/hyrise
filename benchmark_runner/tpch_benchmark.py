...
class TPCHBenchmark(AbstractBenchmark):
  ...
  def result_path(self):
    return "/home/Alexander.Loeser/hyrise/benchmark_results/tpch_mdc_sf_10"
 ...
 'l_shipdate-2400_o_orderdate-600_c_mktsegment-60': {'lineitem': [['l_shipdate',
  ...
  'customer': [('c_mktsegment', 60)]}
    ...
    return {
        'nosort': {},
        'default': {'lineitem': [['l_shipdate', 240]],
  'orders': [['o_orderdate', 60]]},
 'l_shipdate-240_o_orderdate-16_o_orderstatus-4_o_orderdate-1': {'lineitem': [['l_shipdate',
    240]],
  'orders': [('o_orderdate', 16), ('o_orderstatus', 4), ('o_orderdate', 1)]},
 'l_shipdate-240_o_orderstatus-60_o_orderdate-1': {'lineitem': [['l_shipdate',
    240]],
  'orders': [('o_orderstatus', 60), ('o_orderdate', 1)]},
 'l_shipdate-240_o_orderdate-16_o_orderstatus-4': {'lineitem': [['l_shipdate',
    240]],
  'orders': [('o_orderdate', 16), ('o_orderstatus', 4)]},
 'l_shipdate-240_o_orderdate-60_p_name-5_p_size-2_p_type-1': {'lineitem': [['l_shipdate',
    240]],
  'orders': [['o_orderdate', 60]],
  'part': [('p_name', 5), ('p_size', 2), ('p_type', 1)]},
 'l_shipdate-240_o_orderdate-60_p_brand-3_p_size-4_p_type-1': {'lineitem': [['l_shipdate',
    240]],
  'orders': [['o_orderdate', 60]],
  'part': [('p_brand', 3), ('p_size', 4), ('p_type', 1)]},
 'l_shipdate-240_o_orderdate-60_p_container-3_p_size-4_p_type-1': {'lineitem': [['l_shipdate',
    240]],
  'orders': [['o_orderdate', 60]],
 ...
 'l_receiptdate-16_l_shipdate-16_o_orderdate-60': {'lineitem': [('l_receiptdate',
   ...
   ('l_shipdate', 16)],
  'orders': [['o_orderdate', 60]]},
 'l_shipdate-240_o_orderdate-60_c_mktsegment-6': {'lineitem': [['l_shipdate',
    240]],
  'orders': [['o_orderdate', 60]],
