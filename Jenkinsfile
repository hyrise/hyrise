        ...
        try {
          ...
          parallel clangDebug: {
            ...
            stage('bolt') {
              ...
              sh "cd cmake-build-bolt && ../scripts/build_bolt.sh -t 120 -n 4 -c \$(( \$(nproc)  / 7)) -b hyriseBenchmarkTPCH -b hyriseBenchmarkTPCDS -b hyriseBenchmarkTPCC -b hyriseBenchmarkStarSchema"
