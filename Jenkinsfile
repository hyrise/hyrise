...
exclude_in_sanitizer_builds = '--gtest_filter=-SQLiteTestRunnerEncodings.*:TPCHTestNoJITPreparedStatements.*:TpcdsTableGeneratorTest.GenerateAndStoreRowCounts:TPCHTableGeneratorTest.RowCountsMediumScaleFactor'
