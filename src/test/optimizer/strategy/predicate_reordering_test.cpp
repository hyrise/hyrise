...
TEST_F(PredicateReorderingTest, SimpleReorderingTest) {
  ...
  auto predicate_node_0 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::GreaterThan, 10);
  predicate_node_0->set_left_child(stored_table_node);

  auto predicate_node_1 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{1}}, ScanType::GreaterThan, 50);
...
TEST_F(PredicateReorderingTest, MoreComplexReorderingTest) {
  ...
  auto predicate_node_0 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::GreaterThan, 5);
  predicate_node_0->set_left_child(stored_table_node);

  auto predicate_node_1 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{1}}, ScanType::GreaterThan, 1);
  predicate_node_1->set_left_child(predicate_node_0);

  auto predicate_node_2 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{2}}, ScanType::GreaterThan, 9);
...
TEST_F(PredicateReorderingTest, ComplexReorderingTest) {
  ...
  auto predicate_node_2 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{2}}, ScanType::GreaterThan, 90);
  predicate_node_2->set_left_child(predicate_node_1);

  const auto& expressions = LQPExpression::create_columns({LQPColumnOrigin{stored_table_node, ColumnID{0}}, LQPColumnOrigin{stored_table_node, ColumnID{1}}});
  const auto projection_node = std::make_shared<ProjectionNode>(expressions);
  projection_node->set_left_child(predicate_node_2);

  auto predicate_node_3 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::GreaterThan, 10);
  predicate_node_3->set_left_child(projection_node);

  auto predicate_node_4 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{1}}, ScanType::GreaterThan, 50);
...
TEST_F(PredicateReorderingTest, TwoReorderings) {
  ...
  auto predicate_node_3 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{1}}, ScanType::GreaterThan, 50);
...
TEST_F(PredicateReorderingTest, SameOrderingForStoredTable) {
  ...
  auto predicate_node_0 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::LessThan, 20);
  predicate_node_0->set_left_child(stored_table_node);

  auto predicate_node_1 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::LessThan, 40);
  predicate_node_1->set_left_child(predicate_node_0);
  ...
  auto predicate_node_2 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::LessThan, 40);
  predicate_node_2->set_left_child(stored_table_node);

  auto predicate_node_3 = std::make_shared<PredicateNode>(LQPColumnOrigin{stored_table_node, ColumnID{0}}, ScanType::LessThan, 20);
  predicate_node_3->set_left_child(predicate_node_2);
...
TEST_F(PredicateReorderingTest, PredicatesWithMultipleParents) {
  ...
  auto predicate_a_node = std::make_shared<PredicateNode>(LQPColumnOrigin{table_node, ColumnID{0}}, ScanType::GreaterThan, 90);
  auto predicate_b_node = std::make_shared<PredicateNode>(LQPColumnOrigin{table_node, ColumnID{0}}, ScanType::GreaterThan, 10);
