...
class PredicatePlacementRuleTest : public StrategyBaseTest {
 protected:
  void SetUp() override {
    StorageManager::get().add_table("a", load_table("artifacts/test_data/tbl/int_float.tbl"));
    ...
    StorageManager::get().add_table("b", load_table("artifacts/test_data/tbl/int_float2.tbl"));
    ...
    StorageManager::get().add_table("c", load_table("artifacts/test_data/tbl/int_float3.tbl"));
