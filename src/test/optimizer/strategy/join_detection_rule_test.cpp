...
class JoinDetectionRuleTest : public StrategyBaseTest, public ::testing::WithParamInterface<JoinDetectionTestParam> {
 protected:
  void SetUp() override {
    ...
    StorageManager::get().add_table("b", load_table("artifacts/test_data/tbl/int_float.tbl"));
    StorageManager::get().add_table("c", load_table("artifacts/test_data/tbl/int_float.tbl"));
