...
class ChunkPruningTest : public StrategyBaseTest {
 protected:
  void SetUp() override {
    ...
    storage_manager.add_table("compressed", load_table("artifacts/test_data/tbl/int_float2.tbl", 2u));
    storage_manager.add_table("long_compressed", load_table("artifacts/test_data/tbl/25_ints_sorted.tbl", 25u));
    storage_manager.add_table("run_length_compressed", load_table("artifacts/test_data/tbl/10_ints.tbl", 5u));
    storage_manager.add_table("string_compressed", load_table("artifacts/test_data/tbl/string.tbl", 3u));
    storage_manager.add_table("fixed_string_compressed", load_table("artifacts/test_data/tbl/string.tbl", 3u));
    ...
    storage_manager.add_table("uncompressed", load_table("artifacts/test_data/tbl/int_float2.tbl", 10u));
  }
