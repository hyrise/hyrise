...
class PredicatePushdownRuleTest : public StrategyBaseTest {
 protected:
  void SetUp() override {
    ...
    _a_a = LQPColumnReference(_table_a, CxlumnID{0});
    _a_b = LQPColumnReference(_table_a, CxlumnID{1});
    ...
    _b_a = LQPColumnReference(_table_b, CxlumnID{0});
    _b_b = LQPColumnReference(_table_b, CxlumnID{1});
    ...
    _c_a = LQPColumnReference(_table_c, CxlumnID{0});
    _c_b = LQPColumnReference(_table_c, CxlumnID{1});
...

    {
      ...
      auto a = LQPColumnReference{int_float_node_a, CxlumnID{0}};
