...
class ExistsReformulationRuleTest : public StrategyBaseTest {
 public:
  void SetUp() override {
    StorageManager::get().add_table("table_a", load_table("artifacts/test_data/tbl/int_int2.tbl"));
    StorageManager::get().add_table("table_b", load_table("artifacts/test_data/tbl/int_int3.tbl"));
