...
TEST_F(ExpressionTest, ExpressionToStringSimpleArithmetics) {
  auto expr = PQPExpression::create_binary_operator(ExpressionType::Subtraction,
...
TEST_F(ExpressionTest, ExpressionToStringNestedArithmetics) {
  auto expr = PQPExpression::create_binary_operator(
      ExpressionType::Multiplication, PQPExpression::create_binary_operator(
                                          ExpressionType::Subtraction, PQPExpression::create_column(ColumnID{2}),
                                          PQPExpression::create_literal(4)),
      PQPExpression::create_binary_operator(ExpressionType::Multiplication,
                                                 PQPExpression::create_column(ColumnID{3}),
...
TEST_F(ExpressionTest, ExpressionToStringNestedLogical) {
  auto expr = PQPExpression::create_unary_operator(
      ...
      PQPExpression::create_binary_operator(
          ExpressionType::And, PQPExpression::create_binary_operator(
                                   ExpressionType::GreaterThanEquals, PQPExpression::create_column(ColumnID{2}),
                                   PQPExpression::create_literal(4)),
