...
TEST_F(ExpressionTest, ExpressionToStringSimpleArithmetics) {
  auto expr = OperatorExpression::create_binary_operator(ExpressionType::Subtraction,
...
TEST_F(ExpressionTest, ExpressionToStringNestedArithmetics) {
  auto expr = OperatorExpression::create_binary_operator(
      ExpressionType::Multiplication, OperatorExpression::create_binary_operator(
                                          ExpressionType::Subtraction, OperatorExpression::create_column(ColumnID{2}),
                                          OperatorExpression::create_literal(4)),
      OperatorExpression::create_binary_operator(ExpressionType::Multiplication,
                                                 OperatorExpression::create_column(ColumnID{3}),
...
TEST_F(ExpressionTest, ExpressionToStringNestedLogical) {
  auto expr = OperatorExpression::create_unary_operator(
      ...
      OperatorExpression::create_binary_operator(
          ExpressionType::And, OperatorExpression::create_binary_operator(
                                   ExpressionType::GreaterThanEquals, OperatorExpression::create_column(ColumnID{2}),
                                   OperatorExpression::create_literal(4)),
