...
TEST_F(ExpressionTest, MapColumnIDs) {
  ...
  auto expr = Expression::create_binary_operator(
      ExpressionType::And,
      Expression::create_binary_operator(
          ExpressionType::GreaterThanEquals, c,
          Expression::create_binary_operator(ExpressionType::Subtraction, Expression::create_literal(4), a)),
      Expression::create_binary_operator(ExpressionType::GreaterThan,
                                         Expression::create_aggregate_function(AggregateFunction::Sum, {d}),
