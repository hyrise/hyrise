...
TEST_F(TableStatisticsTest, NotEqualTest) {
  ...
  check_column_with_values(_table_a_with_statistics, "i", scan_type, _int_values);
  check_column_with_values(_table_a_with_statistics, "f", scan_type, _float_values);
  check_column_with_values(_table_a_with_statistics, "d", scan_type, _double_values);
...
TEST_F(TableStatisticsTest, LessThanTest) {
  ...
  check_column_with_values(_table_a_with_statistics, "f", scan_type, custom_float_values);
  std::vector<double> custom_double_values{0., 1., 5.1, 7.};
  check_column_with_values(_table_a_with_statistics, "d", scan_type, custom_double_values);
...
TEST_F(TableStatisticsTest, BetweenTest) {
  ...
  check_column_with_values(_table_a_with_statistics, "i", scan_type, int_values);
  std::vector<std::pair<float, float>> float_values{{-1.f, 0.f}, {-1.f, 1.9f}, {1.f, 1.9f}, {0.f, 7.f},
                                                    {5.1f, 6.f}, {5.1f, 8.f},  {7.f, 8.f}};
  check_column_with_values(_table_a_with_statistics, "f", scan_type, float_values);
  std::vector<std::pair<double, double>> double_values{{-1., 0.}, {-1., 1.9}, {1., 1.9}, {0., 7.},
                                                       {5.1, 6.}, {5.1, 8.},  {7., 8.}};
  check_column_with_values(_table_a_with_statistics, "d", scan_type, double_values);
...
TEST_F(TableStatisticsTest, MultipleColumnTableScans) {
  auto container = check_statistic_with_table_scan(_table_a_with_statistics, "d", ScanType::OpBetween,
