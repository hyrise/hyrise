...
TEST_F(LQPTranslatorTest, PredicateNodeIndexScan) {
  ...
  table->get_modifiable_chunk(index_chunk_ids[0])->create_index<GroupKeyIndex>(index_column_ids);
  table->get_modifiable_chunk(index_chunk_ids[1])->create_index<GroupKeyIndex>(index_column_ids);
