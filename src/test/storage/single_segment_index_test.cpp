...
TYPED_TEST(SingleSegmentIndexTest, LowerBoundTest) {
  ...
  // A2, B4, C1, D2
  EXPECT_EQ(this->index_long_mixed->lower_bound({3}), this->index_long_mixed->cbegin() + 1);
  // A3, B4, C1, D2
...
TYPED_TEST(SingleSegmentIndexTest, UpperBoundTest) {
  ...
  // A2, B4, C1, D2
  EXPECT_EQ(this->index_long_mixed->upper_bound({3}), this->index_long_mixed->cbegin() + 3);
  // A3, B4, C1, D2
