...
class MaterializeTest : public EncodingTest {
 public:
  void SetUp() override {
    _data_table = load_table_with_encoding("artifacts/test_data/tbl/int_float.tbl", 2);
    _data_table_with_nulls = load_table_with_encoding("artifacts/test_data/tbl/int_float_with_null.tbl", 2);
