...
TEST_F(SegmentAccessorTest, TestValueSegmentInt) {
  ...
  EXPECT_TRUE((dynamic_cast<SegmentAccessor<int, ValueSegment<int>>*>(val_seg_int_base_accessor.get()) != nullptr));
}
...
TEST_F(SegmentAccessorTest, TestValueSegmentString) {
  ...
  EXPECT_TRUE((dynamic_cast<SegmentAccessor<pmr_string, ValueSegment<pmr_string>>*>(val_seg_str_accessor.get()) != nullptr));
}
...
TEST_F(SegmentAccessorTest, TestDictionarySegmentInt) {
  ...
  EXPECT_TRUE((dynamic_cast<SegmentAccessor<int, DictionarySegment<int>>*>(dict_seg_int_accessor.get()) != nullptr));
}
...
TEST_F(SegmentAccessorTest, TestDictionarySegmentString) {
  ...
  EXPECT_TRUE((dynamic_cast<SegmentAccessor<pmr_string, DictionarySegment<pmr_string>>*>(dict_seg_str_accessor.get()) != nullptr));
}
...
TEST_F(SegmentAccessorTest, TestReferenceSegmentToValueSegmentInt) {
  ...
  EXPECT_TRUE((dynamic_cast<MultipleChunkReferenceSegmentAccessor<int>*>(ref_seg_int_accessor.get()) != nullptr));
}
...
TEST_F(SegmentAccessorTest, TestReferenceSegmentToDictionarySegmentString) {
  ...
  EXPECT_TRUE((dynamic_cast<MultipleChunkReferenceSegmentAccessor<pmr_string>*>(ref_seg_str_accessor.get()) != nullptr));
}
