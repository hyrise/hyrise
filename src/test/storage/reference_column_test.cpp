...
class ReferenceColumnTest : public ::testing::Test {
  virtual void SetUp() {
    ...
    _test_table->add_column("a", TypeSymbol::Int, true);
    _test_table->add_column("b", TypeSymbol::Float);
    ...
    _test_table_dict->add_column("a", TypeSymbol::Int);
    _test_table_dict->add_column("b", TypeSymbol::Int);
