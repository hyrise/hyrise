...
class ReferenceColumnTest : public BaseTest {
  virtual void SetUp() {
    ...
    _test_table = std::make_shared<opossum::Table>(column_definitions);
    ...
    _test_table_dict = std::make_shared<opossum::Table>(column_definitions2, TableType::Data, UseMvcc::No, 5);
