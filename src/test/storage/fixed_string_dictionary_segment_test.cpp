...
TEST_F(StorageFixedStringDictionarySegmentTest, CompressSegmentString) {
  ...
  auto segment = encode_and_compress_segment(vs_str, DataType::String, SegmentEncodingSpec{EncodingType::FixedStringDictionary});
...
TEST_F(StorageFixedStringDictionarySegmentTest, MemoryUsageEstimation) {
   ...
   */
  const auto empty_compressed_segment = encode_and_compress_segment(vs_str, DataType::String, SegmentEncodingSpec{EncodingType::FixedStringDictionary});
  ...
  vs_str->append("B");
  vs_str->append("C");
  const auto compressed_segment = encode_and_compress_segment(vs_str, DataType::String, SegmentEncodingSpec{EncodingType::FixedStringDictionary});
