...
TEST(TpchDbGeneratorTest, TableContents) {
  ...
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::Part), load_table_cached("src/test/tables/tpch/sf-0.001/part.tbl", chunk_size));
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::Supplier),
                          load_table_cached("src/test/tables/tpch/sf-0.001/supplier.tbl", chunk_size));
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::PartSupp),
                          load_table_cached("src/test/tables/tpch/sf-0.001/partsupp.tbl", chunk_size));
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::Customer),
                          load_table_cached("src/test/tables/tpch/sf-0.001/customer.tbl", chunk_size));
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::Orders),
                          load_table_cached("src/test/tables/tpch/sf-0.001/orders.tbl", chunk_size));
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::Nation),
                          load_table_cached("src/test/tables/tpch/sf-0.001/nation.tbl", chunk_size));
  EXPECT_TABLE_EQ_ORDERED(tables.at(TpchTable::Region),
                          load_table_cached("src/test/tables/tpch/sf-0.001/region.tbl", chunk_size));
}
