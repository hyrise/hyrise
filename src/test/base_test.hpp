...
class BaseTestWithParam : public std::conditional<std::is_same<ParamType, void>::value, ::testing::Test,
 ...
 protected:
  ...
  template <class T>
  static std::shared_ptr<DictionaryColumn<T>> create_dict_column_by_type(TypeSymbol type_symbol,
    ...
    auto compressed_column = DictionaryCompression::compress_column(type_symbol, value_column);
