...
TEST_F(CreateTableTest, Execute) {
  const auto context = Hyrise::get().transaction_manager.new_transaction_context(IsAutoCommitTransaction::Yes);
...
TEST_F(CreateTableTest, TableAlreadyExists) {
  ...
  const auto context_2 = Hyrise::get().transaction_manager.new_transaction_context(IsAutoCommitTransaction::Yes);
  const auto context_3 = Hyrise::get().transaction_manager.new_transaction_context(IsAutoCommitTransaction::Yes);
...
TEST_F(CreateTableTest, CreateTableWithDifferentTransactionContexts) {
  ...
  const auto context_1 = Hyrise::get().transaction_manager.new_transaction_context(IsAutoCommitTransaction::Yes);
  const auto context_2 = Hyrise::get().transaction_manager.new_transaction_context(IsAutoCommitTransaction::Yes);
  const auto context_3 = Hyrise::get().transaction_manager.new_transaction_context(IsAutoCommitTransaction::Yes);
