...
TYPED_TEST(OperatorsAggregateTest, CannotStdDevSampStringColumns) {
  auto aggregate =
      std::make_shared<TypeParam>(this->_table_wrapper_1_1_string,
                                  std::vector<AggregateColumnDefinition>{{ColumnID{0}, AggregateFunction::StdDevSamp}},
                                  std::vector<ColumnID>{ColumnID{0}});
  EXPECT_THROW(aggregate->execute(), std::logic_error);
}
...
TYPED_TEST(OperatorsAggregateTest, SingleAggregateStdDevSamp) {
  this->test_output(this->_table_wrapper_1_1, {{ColumnID{1}, AggregateFunction::StdDevSamp}}, {ColumnID{0}},
...
TYPED_TEST(OperatorsAggregateTest, StringSingleAggregateStdDevSamp) {
  this->test_output(this->_table_wrapper_1_1_string, {{ColumnID{1}, AggregateFunction::StdDevSamp}}, {ColumnID{0}},
...
TYPED_TEST(OperatorsAggregateTest, TwoAggregateMaxStdDevSamp) {
  this->test_output(
      this->_table_wrapper_1_2, {{ColumnID{1}, AggregateFunction::Max}, {ColumnID{2}, AggregateFunction::StdDevSamp}},
      {ColumnID{0}}, "resources/test_data/tbl/aggregateoperator/groupby_int_1gb_2agg/max_stddev_samp.tbl", 1);
}
...
TYPED_TEST(OperatorsAggregateTest, TwoAggregateMinStdDevSamp) {
  this->test_output(
      this->_table_wrapper_1_2, {{ColumnID{1}, AggregateFunction::Min}, {ColumnID{2}, AggregateFunction::StdDevSamp}},
      {ColumnID{0}}, "resources/test_data/tbl/aggregateoperator/groupby_int_1gb_2agg/min_stddev_samp.tbl", 1);
}
...
TYPED_TEST(OperatorsAggregateTest, TwoAggregateStdDevSampStdDevSamp) {
  this->test_output(this->_table_wrapper_1_2,
                    {{ColumnID{1}, AggregateFunction::StdDevSamp}, {ColumnID{2}, AggregateFunction::StdDevSamp}},
                    {ColumnID{0}},
...
TYPED_TEST(OperatorsAggregateTest, TwoGroupbyStdDevSamp) {
  this->test_output(this->_table_wrapper_2_1, {{ColumnID{2}, AggregateFunction::StdDevSamp}},
...
TYPED_TEST(OperatorsAggregateTest, ThreeGroupbyStdDevSamp) {
  this->test_output(this->_table_wrapper_3_1, {{ColumnID{2}, AggregateFunction::StdDevSamp}},
                    {ColumnID{0}, ColumnID{1}, ColumnID{3}},
...
TYPED_TEST(OperatorsAggregateTest, TwoGroupbyAndTwoAggregateStdDevSampAvg) {
  this->test_output(this->_table_wrapper_2_2,
                    {{ColumnID{2}, AggregateFunction::StdDevSamp}, {ColumnID{3}, AggregateFunction::Avg}},
                    {ColumnID{0}, ColumnID{1}},
                    "resources/test_data/tbl/aggregateoperator/groupby_int_2gb_2agg/stddev_samp_avg.tbl", 1);
}

TYPED_TEST(OperatorsAggregateTest, TwoGroupbyAndTwoAggregateStdDevSampStdDevSamp) {
  this->test_output(this->_table_wrapper_2_2,
                    {{ColumnID{2}, AggregateFunction::StdDevSamp}, {ColumnID{3}, AggregateFunction::StdDevSamp}},
                    {ColumnID{0}, ColumnID{1}},
...
TYPED_TEST(OperatorsAggregateTest, NoGroupbySingleAggregateStdDevSamp) {
  this->test_output(this->_table_wrapper_1_1, {{ColumnID{1}, AggregateFunction::StdDevSamp}}, {},
...
TYPED_TEST(OperatorsAggregateTest, SingleAggregateStdDevSampWithNull) {
  this->test_output(this->_table_wrapper_1_1_null, {{ColumnID{1}, AggregateFunction::StdDevSamp}}, {ColumnID{0}},
...
TYPED_TEST(OperatorsAggregateTest, DictionarySingleAggregateStdDevSampWithNull) {
  this->test_output(this->_table_wrapper_1_1_null_dict, {{ColumnID{1}, AggregateFunction::StdDevSamp}}, {ColumnID{0}},
                    "resources/test_data/tbl/aggregateoperator/groupby_int_1gb_1agg/stddev_samp_null.tbl", 1, false);
}
...
TYPED_TEST(OperatorsAggregateTest, TwoAggregateStdDevSampAvgOnRef) {
  auto filtered = std::make_shared<TableScan>(
      this->_table_wrapper_1_2, less_than_(this->get_column_expression(this->_table_wrapper_1_2, ColumnID{0}), "100"));
  filtered->execute();

  this->test_output(filtered, {{ColumnID{1}, AggregateFunction::StdDevSamp}, {ColumnID{2}, AggregateFunction::Avg}},
                    {ColumnID{0}},
                    "resources/test_data/tbl/aggregateoperator/groupby_int_1gb_2agg/stddev_samp_avg_filtered.tbl", 1);
}
...
TYPED_TEST(OperatorsAggregateTest, DictionarySingleAggregateStdDevSampOnRef) {
  auto filtered = std::make_shared<TableScan>(
      this->_table_wrapper_1_1_dict,
      less_than_(this->get_column_expression(this->_table_wrapper_1_1_dict, ColumnID{0}), "100"));
  filtered->execute();

  this->test_output(filtered, {{ColumnID{1}, AggregateFunction::StdDevSamp}}, {ColumnID{0}},
