...
TYPED_TEST(JoinEquiTest, InnerJoinIntFloat) {
  ...
  this->template test_join_output<TypeParam>(
      ...
      PredicateCondition::Equals, JoinMode::Inner, "artifacts/test_data/tbl/joinoperators/int_float_inner.tbl", 1);

  // float with int
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_o, this->_table_wrapper_a, ColumnIDPair(ColumnID{0}, ColumnID{0}),
      PredicateCondition::Equals, JoinMode::Inner, "artifacts/test_data/tbl/joinoperators/float_int_inner.tbl", 1);
}
...
TYPED_TEST(JoinEquiTest, InnerJoinIntFloatRadixBit) {
  if constexpr (std::is_same_v<TypeParam, JoinHash>) {
    // float with int
    // radix bits = 0
    std::shared_ptr<Table> expected_result = load_table("artifacts/test_data/tbl/joinoperators/float_int_inner.tbl", 1);
...
TYPED_TEST(JoinEquiTest, InnerJoinIntDouble) {
  ...
  this->template test_join_output<TypeParam>(
      ...
      PredicateCondition::Equals, JoinMode::Inner, "artifacts/test_data/tbl/joinoperators/int_double_inner.tbl", 1);

  // double with int
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_p, this->_table_wrapper_a, ColumnIDPair(ColumnID{0}, ColumnID{0}),
      PredicateCondition::Equals, JoinMode::Inner, "artifacts/test_data/tbl/joinoperators/double_int_inner.tbl", 1);
}
...
TYPED_TEST(JoinEquiTest, InnerJoinIntString) {
  ...
  this->template test_join_output<TypeParam>(
      ...
      PredicateCondition::Equals, JoinMode::Inner, "artifacts/test_data/tbl/joinoperators/int_string_inner.tbl", 1);
}
...
TYPED_TEST(JoinEquiTest, MultiJoinOnValue) {
  ...
  this->template test_join_output<TypeParam>(
      ...
      "artifacts/test_data/tbl/joinoperators/int_inner_multijoin_val_val_val_left.tbl", 1);
}
...
TYPED_TEST(JoinEquiTest, MixNestedLoopAndHash) {
  ...
  this->template test_join_output<TypeParam>(
      join, this->_table_wrapper_h, ColumnIDPair(ColumnID{0}, ColumnID{0}), PredicateCondition::Equals, JoinMode::Inner,
      "artifacts/test_data/tbl/joinoperators/int_inner_multijoin_nlj_hash.tbl", 1);
}
...
TYPED_TEST(JoinEquiTest, DISABLED_JoinOnUnion /* #160 */) {
  ...
  this->template test_join_output<TypeParam>(union_left, union_right, ColumnIDPair(ColumnID{0}, ColumnID{0}),
                                             PredicateCondition::Equals, JoinMode::Inner,
                                             "artifacts/test_data/tbl/joinoperators/expected_join_result_1.tbl", 1);
}
