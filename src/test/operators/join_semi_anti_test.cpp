...
TYPED_TEST(JoinSemiAntiTest, SemiJoinRefSegments) {
  ...
  this->template test_join_output<TypeParam>(scan_a, scan_b, {{ColumnID{0}, ColumnID{0}}, PredicateCondition::Equals}, JoinMode::Semi,
                             "resources/test_data/tbl/int.tbl", 1);
}
...
TYPED_TEST(JoinSemiAntiTest, AntiNullAsFalseWithNullsLarger) {
  this->template test_join_output<TypeParam>(this->_table_wrapper_int_int_string_nulls_random, this->_table_wrapper_int_int_string_nulls_random,
                             {{ColumnID{0}, ColumnID{0}}, PredicateCondition::Equals}, JoinMode::AntiNullAsFalse,
