...
TEST_F(OperatorsInsertTest, SelfInsert) {
  ...
  auto t = load_table("artifacts/test_data/tbl/float_int.tbl");
...
TEST_F(OperatorsInsertTest, InsertRespectChunkSize) {
  ...
  // 3 Rows, chunk_size = 4
  auto t = load_table("artifacts/test_data/tbl/int.tbl", 4u);
  StorageManager::get().add_table(t_name, t);

  // 10 Rows
  auto t2 = load_table("artifacts/test_data/tbl/10_ints.tbl");
...
TEST_F(OperatorsInsertTest, MultipleChunks) {
  ...
  // 3 Rows
  auto t = load_table("artifacts/test_data/tbl/int.tbl", 2u);
  StorageManager::get().add_table(t_name, t);

  // 10 Rows
  auto t2 = load_table("artifacts/test_data/tbl/10_ints.tbl", 3u);
  StorageManager::get().add_table(t_name2, t2);
...
TEST_F(OperatorsInsertTest, InsertStringNullValue) {
  ...
  auto t = load_table("artifacts/test_data/tbl/string_with_null.tbl", 4u);
  StorageManager::get().add_table(t_name, t);

  auto t2 = load_table("artifacts/test_data/tbl/string_with_null.tbl", 4u);
  StorageManager::get().add_table(t_name2, t2);
...
TEST_F(OperatorsInsertTest, InsertIntFloatNullValues) {
  ...
  auto t = load_table("artifacts/test_data/tbl/int_float_with_null.tbl", 3u);
  StorageManager::get().add_table(t_name, t);

  auto t2 = load_table("artifacts/test_data/tbl/int_float_with_null.tbl", 4u);
  StorageManager::get().add_table(t_name2, t2);
...
TEST_F(OperatorsInsertTest, InsertNullIntoNonNull) {
  ...
  auto t = load_table("artifacts/test_data/tbl/int_float.tbl", 3u);
  StorageManager::get().add_table(t_name, t);
...
TEST_F(OperatorsInsertTest, InsertSingleNullFromDummyProjection) {
  ...
  auto t = load_table("artifacts/test_data/tbl/float_with_null.tbl", 4u);
  StorageManager::get().add_table(t_name, t);
...
TEST_F(OperatorsInsertTest, InsertIntoEmptyTable) {
  ...
  const auto table_int_float = load_table("artifacts/test_data/tbl/int_float.tbl");
