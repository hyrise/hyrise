...
TEST_F(OperatorsExportBinaryTest, TwoColumnsNoValues) {
  ...
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/TwoColumnsNoValues.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, SingleChunkSingleFloatColumn) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/SingleChunkSingleFloatColumn.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, MultipleChunkSingleFloatColumn) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/MultipleChunkSingleFloatColumn.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, StringValueSegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/StringValueSegment.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, StringDictionarySegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/StringDictionarySegment.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, AllTypesValueSegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/AllTypesValueSegment.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, AllTypesDictionarySegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/AllTypesDictionarySegment.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, AllTypesMixColumn) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/AllTypesMixColumn.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, AllTypesReferenceSegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/AllTypesValueSegmentMaxChunkSize.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, EmptyStringsValueSegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/EmptyStringsValueSegment.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, EmptyStringsDictionarySegment) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/EmptyStringsDictionarySegment.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, AllTypesNullValues) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/AllTypesNullValues.bin", filename));
}
...
TEST_F(OperatorsExportBinaryTest, AllTypesDictionaryNullValues) {
  ...
  EXPECT_TRUE(file_exists(filename));
  EXPECT_TRUE(compare_files("artifacts/test_data/bin/AllTypesDictionaryNullValues.bin", filename));
}
