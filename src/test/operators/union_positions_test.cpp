...
TEST_F(UnionPositionsTest, MultipleShuffledPosList) {
  ...
  auto table_left = std::make_shared<Table>(column_definitions, TableType::References, UseMvcc::No, 3);

  table_left->add_chunk_new(std::vector<std::shared_ptr<BaseColumn>>({column_left_0_0, column_left_0_1, column_left_0_2}));
  table_left->add_chunk_new(std::vector<std::shared_ptr<BaseColumn>>({column_left_1_0, column_left_1_1, column_left_1_2}));

  auto table_right = std::make_shared<Table>(column_definitions, TableType::References, UseMvcc::No, 4);

  table_right->add_chunk_new(std::vector<std::shared_ptr<BaseColumn>>({column_right_0_0, column_right_0_1, column_right_0_2}));
  table_right->add_chunk_new(std::vector<std::shared_ptr<BaseColumn>>({column_right_1_0, column_right_1_1, column_right_1_2}));
