...
TEST_F(UnionPositionsTest, MultipleShuffledPosList) {
  ...
  table_left->add_chunk_new(ChunkColumnList({column_left_0_0, column_left_0_1, column_left_0_2}));
  table_left->add_chunk_new(ChunkColumnList({column_left_1_0, column_left_1_1, column_left_1_2}));
