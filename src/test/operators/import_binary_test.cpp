...
TEST_F(OperatorsImportBinaryTest, SingleChunkSingleFloatColumn) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/SingleChunkSingleFloatColumn.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, MultipleChunkSingleFloatColumn) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/MultipleChunkSingleFloatColumn.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, StringValueSegment) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/StringValueSegment.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, StringDictionarySegment) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/StringDictionarySegment.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, AllTypesValueSegment) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/AllTypesValueSegment.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, AllTypesDictionarySegment) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/AllTypesDictionarySegment.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, AllTypesMixColumn) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/AllTypesMixColumn.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, TwoColumnsNoValues) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/TwoColumnsNoValues.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, EmptyStringsValueSegment) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/EmptyStringsValueSegment.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, EmptyStringsDictionarySegment) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/EmptyStringsDictionarySegment.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, SaveToStorageManager) {
  auto importer =
      std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/float.bin", std::string("float_table"));
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, FallbackToRetrieveFromStorageManager) {
  auto importer =
      std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/float.bin", std::string("float_table"));
  importer->execute();
  auto retriever = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/AllTypesMixColumn.bin",
...
TEST_F(OperatorsImportBinaryTest, InvalidColumnType) {
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/InvalidColumnType.bin",
                                                          std::string("float_table"));
  EXPECT_THROW(importer->execute(), std::exception);
}

TEST_F(OperatorsImportBinaryTest, InvalidAttributeVectorWidth) {
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/InvalidAttributeVectorWidth.bin",
                                                          std::string("float_table"));
  EXPECT_THROW(importer->execute(), std::exception);
}
...
TEST_F(OperatorsImportBinaryTest, AllTypesNullValues) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/AllTypesNullValues.bin");
  importer->execute();
...
TEST_F(OperatorsImportBinaryTest, AllTypesDictionaryNullValues) {
  ...
  auto importer = std::make_shared<opossum::ImportBinary>("artifacts/test_data/bin/AllTypesDictionaryNullValues.bin");
  importer->execute();
