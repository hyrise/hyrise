...
TEST_F(JitExpressionTest, Is_Not_Null) {
  ...
  auto tuple_entry = std::make_shared<JitTupleEntry>(DataType::Int, true, 0);
  auto result_index = 1;
...
TEST_F(JitExpressionTest, Not) {
  ...
  {
    auto tuple_entry = std::make_shared<JitTupleEntry>(DataType::Bool, false, 0);
  ...
  {
    auto tuple_entry = std::make_shared<JitTupleEntry>(DataType::Bool, true, 0);
    JitExpression expression(std::make_shared<JitExpression>(tuple_entry), JitExpressionType::Not, result_index);
    ASSERT_EQ(expression.result_entry->data_type, DataType::Bool);
  ...
  if (HYRISE_DEBUG) {
    ...
    auto tuple_entry = std::make_shared<JitTupleEntry>(DataType::Long, false, 0);
    JitExpression expression(std::make_shared<JitExpression>(tuple_entry), JitExpressionType::Not, result_index);
...
TEST_F(JitExpressionTest, ArithmeticOperations) {
  ...
  auto zero_value = static_cast<int32_t>(0);

  auto int_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Int, false, 0);
  auto long_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Long, false, 1);
  auto float_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Float, false, 2);
  auto double_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Double, false, 3);
  auto null_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Int, true, 4);
  auto zero_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Int, true, 5);
  ...
  zero_tuple_entry->set<int32_t>(zero_value, context);
...
TEST_F(JitExpressionTest, PredicateOperations) {
  ...
  auto left_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Int, false, 0);
  auto right_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Int, false, 1);
  auto result_index = 2;
  ...
  auto string_tuple_entry = std::make_shared<JitTupleEntry>(DataType::String, false, 1);
...
TEST_F(JitExpressionTest, StringComparison) {
  ...
  auto left_tuple_entry = std::make_shared<JitTupleEntry>(DataType::String, false, 0);
  auto right_tuple_entry = std::make_shared<JitTupleEntry>(DataType::String, false, 1);
  auto result_index = 2;
...
TEST_F(JitExpressionTest, NestedExpressions) {
  ...
  auto b_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Long, false, 1);
  auto c_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Float, false, 2);
  auto d_tuple_entry = std::make_shared<JitTupleEntry>(DataType::Double, false, 3);
