...
TEST_F(JitAggregateTest, AddsAggregateColumnsToOutputTable) {
  _aggregate->add_aggregate_column("count", JitTupleEntry(DataType::String, true, 0), AggregateFunction::CountNonNull);
  _aggregate->add_aggregate_column("count_nullable", JitTupleEntry(DataType::Int, false, 0), AggregateFunction::CountNonNull);
