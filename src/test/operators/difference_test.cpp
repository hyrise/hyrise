...
class OperatorsDifferenceTest : public BaseTest {
 protected:
  virtual void SetUp() {
    ...
    _table_wrapper_b = std::make_shared<TableWrapper>(load_table("artifacts/test_data/tbl/int_float3.tbl", 2));
...
TEST_F(OperatorsDifferenceTest, ThrowWrongColumnNumberException) {
  ...
  auto table_wrapper_c = std::make_shared<TableWrapper>(load_table("artifacts/test_data/tbl/int.tbl", 2));
...
TEST_F(OperatorsDifferenceTest, ThrowWrongColumnOrderException) {
  ...
  auto table_wrapper_d = std::make_shared<TableWrapper>(load_table("artifacts/test_data/tbl/float_int.tbl", 2));
