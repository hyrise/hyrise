...
class JoinIndexTest : public BaseTest {
 protected:
  ...
  void test_join_output(const std::shared_ptr<const AbstractOperator>& left,
    ...
    auto join = std::make_shared<JoinIndex>(left, right, mode, cxlumn_ids, predicate_condition);
...
TYPED_TEST(JoinIndexTest, LeftJoinOnString) {
  this->test_join_output(this->_table_wrapper_c, this->_table_wrapper_d,
                         std::pair<CxlumnID, CxlumnID>(CxlumnID{1}, CxlumnID{0}), PredicateCondition::Equals,
...
TYPED_TEST(JoinIndexTest, InnerRefJoin) {
  ...
  this->test_join_output(scan_a, scan_b, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
...
TYPED_TEST(JoinIndexTest, InnerJoinBig) {
  this->test_join_output(this->_table_wrapper_c, this->_table_wrapper_d,
                         std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{1}), PredicateCondition::Equals,
...
TYPED_TEST(JoinIndexTest, InnerRefJoinFilteredBig) {
  ...
  this->test_join_output(scan_c, scan_d, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{1}),
                         PredicateCondition::Equals, JoinMode::Inner,
...
TYPED_TEST(JoinIndexTest, JoinOnReferenceSegmentAndDict) {
  ...
  this->test_join_output(scan_a, this->_table_wrapper_b, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
                         PredicateCondition::Equals, JoinMode::Inner,
                         "src/test/tables/joinoperators/int_inner_join.tbl", 1);
}
...
TYPED_TEST(JoinIndexTest, JoinOnDictAndReferenceSegment) {
  // scan that returns all rows
  auto scan_b = std::make_shared<TableScan>(this->_table_wrapper_b, CxlumnID{0}, PredicateCondition::GreaterThan, 100);
  scan_b->execute();

  this->test_join_output(this->_table_wrapper_a, scan_b, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
...
TYPED_TEST(JoinIndexTest, MultiJoinOnReferenceLeft) {
  ...
  this->test_join_output(join, scan_c, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
                         PredicateCondition::Equals, JoinMode::Inner,
...
TYPED_TEST(JoinIndexTest, MultiJoinOnReferenceRight) {
  ...
  this->test_join_output(scan_c, join, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
                         PredicateCondition::Equals, JoinMode::Inner,
...
TYPED_TEST(JoinIndexTest, MultiJoinOnRefOuter) {
  ...
  this->test_join_output(join, this->_table_wrapper_h, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
                         PredicateCondition::Equals, JoinMode::Inner,
...
TYPED_TEST(JoinIndexTest, LeftJoinEmptyRefCxlumn) {
  ...
  this->test_join_output(this->_table_wrapper_b, scan_b, std::pair<CxlumnID, CxlumnID>(CxlumnID{0}, CxlumnID{0}),
