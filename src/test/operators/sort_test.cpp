...
TEST_F(OperatorsSortTest, AscendingSortOfOneColumn) {
  ...
  auto sort = std::make_shared<Sort>(_table_wrapper, "a", OrderByMode::Ascending, 2u);
  sort->execute();
...
TEST_F(OperatorsSortTest, AscendingSortOfOneColumnWithoutChunkSize) {
  ...
  auto sort = std::make_shared<Sort>(_table_wrapper, "a", OrderByMode::Ascending);
  sort->execute();
...
TEST_F(OperatorsSortTest, DoubleSortOfOneColumn) {
  ...
  auto sort1 = std::make_shared<Sort>(_table_wrapper, "a", OrderByMode::Descending, 2u);
  sort1->execute();

  auto sort2 = std::make_shared<Sort>(sort1, "a", OrderByMode::Ascending, 2u);
  sort2->execute();
...
TEST_F(OperatorsSortTest, DescendingSortOfOneColumn) {
  ...
  auto sort = std::make_shared<Sort>(_table_wrapper, "a", OrderByMode::Descending, 2u);
  sort->execute();
...
TEST_F(OperatorsSortTest, MultipleColumnSort) {
  ...
  auto sort_after_b = std::make_shared<Sort>(table_wrapper, "b", OrderByMode::Ascending, 2u);
  sort_after_b->execute();

  auto sort_after_a = std::make_shared<Sort>(sort_after_b, "a", OrderByMode::Ascending, 2u);
