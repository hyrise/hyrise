...
TEST_F(OperatorsValidateVisibilityTest, Impossible) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 2;
...
TEST_F(OperatorsValidateVisibilityTest, PastDelete) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 42;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 2;
...
TEST_F(OperatorsValidateVisibilityTest, Impossible2) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 4;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 1;
...
TEST_F(OperatorsValidateVisibilityTest, OwnDeleteUncommitted) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 1;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 6;
...
TEST_F(OperatorsValidateVisibilityTest, Impossible3) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 50;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 3;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 1;
...
TEST_F(OperatorsValidateVisibilityTest, OwnInsert) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 3;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 3;
...
TEST_F(OperatorsValidateVisibilityTest, PastInsertOrFutureDelete) {
  ...
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->tids[0] = 99;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->begin_cids[0] = 2;
  t->get_modifiable_chunk(ChunkID{0}).mvcc_columns()->end_cids[0] = 3;
