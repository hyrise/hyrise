...
class SetOperatorIntegrationTest : public BaseTest {
 protected:
  ...
  const std::string _intersect_query_b =
      "(SELECT * FROM table_a INTERSECT SELECT * FROM table_b) INTERSECT SELECT * FROM table_b";
  const std::string _except_query_a = "SELECT * FROM table_a EXCEPT SELECT * FROM table_b";
  const std::string _multiple_set_operations_query_a =
      "SELECT * FROM table_a EXCEPT (SELECT * FROM table_b INTERSECT SELECT * FROM table_a)";
  const std::string _multiple_set_operations_query_b =
      "SELECT * FROM table_a EXCEPT (SELECT * FROM (SELECT * FROM table_b EXCEPT SELECT * FROM table_c) INTERSECT "
      "SELECT * FROM table_a)";
};
