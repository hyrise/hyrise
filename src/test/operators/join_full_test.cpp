...
TYPED_TEST(JoinFullTest, InnerJoinSingleChunk) {
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_e, this->_table_wrapper_f, JoinColumnIDs(ColumnID{1}, ColumnID{0}),
...
TYPED_TEST(JoinFullTest, SmallerInnerJoin) {
  ...
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_a, this->_table_wrapper_b, JoinColumnIDs(ColumnID{1}, ColumnID{1}),
...
TYPED_TEST(JoinFullTest, SmallerInnerJoin2) {
  // Joining two Integer Columns
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_j, this->_table_wrapper_i, JoinColumnIDs(ColumnID{0}, ColumnID{0}),
...
TYPED_TEST(JoinFullTest, GreaterInnerJoin2) {
  // Joining two Integer Columns
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_i, this->_table_wrapper_j, JoinColumnIDs(ColumnID{0}, ColumnID{0}),
...
TYPED_TEST(JoinFullTest, JoinOnValueAndReferenceColumn) {
  ...
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_a, scan_b, JoinColumnIDs(ColumnID{0}, ColumnID{0}), ScanType::OpNotEquals,
...
TYPED_TEST(JoinFullTest, JoinOnReferenceColumnAndDict) {
  ...
  this->template test_join_output<TypeParam>(
      scan_a, this->_table_wrapper_b_dict, JoinColumnIDs(ColumnID{0}, ColumnID{0}), ScanType::OpEquals,
      JoinMode::Inner, "src/test/tables/joinoperators/int_inner_join.tbl", 1);
}
...
TYPED_TEST(JoinFullTest, JoinOnDictAndReferenceColumn) {
  ...
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_a_dict, scan_b, JoinColumnIDs(ColumnID{0}, ColumnID{0}),
