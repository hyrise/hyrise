...
TYPED_TEST(JoinFullTest, InnerJoinSingleChunk) {
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_e, this->_table_wrapper_f, CxlumnIDPair(CxlumnID{1}, CxlumnID{0}),
...
TYPED_TEST(JoinFullTest, SmallerOuterJoin) {
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_k, this->_table_wrapper_l, CxlumnIDPair(CxlumnID{0}, CxlumnID{0}),
...
TYPED_TEST(JoinFullTest, GreaterOuterJoin) {
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_l, this->_table_wrapper_k, CxlumnIDPair(CxlumnID{0}, CxlumnID{0}),
...
TYPED_TEST(JoinFullTest, JoinOnDictAndReferenceSegment) {
  ...
  this->template test_join_output<TypeParam>(
      this->_table_wrapper_a_dict, scan_b, CxlumnIDPair(CxlumnID{0}, CxlumnID{0}), PredicateCondition::NotEquals,
