...
class OperatorsLimitTest : public BaseTest {
 protected:
  void SetUp() override {
    _table_wrapper = std::make_shared<TableWrapper>(load_table("artifacts/test_data/tbl/int_int3.tbl", 3));
  ...
  void test_limit_1() {
    ...
    auto expected_result = load_table("artifacts/test_data/tbl/int_int3_limit_1.tbl", 3);
  ...
  void test_limit_2() {
    ...
    auto expected_result = load_table("artifacts/test_data/tbl/int_int3_limit_2.tbl", 3);
    EXPECT_TABLE_EQ_ORDERED(limit->get_output(), expected_result);
  }
  ...
  void test_limit_4() {
    ...
    auto expected_result = load_table("artifacts/test_data/tbl/int_int3_limit_4.tbl", 3);
    EXPECT_TABLE_EQ_ORDERED(limit->get_output(), expected_result);
  }
  ...
  void test_limit_10() {
    ...
    auto expected_result = load_table("artifacts/test_data/tbl/int_int3.tbl", 3);
    EXPECT_TABLE_EQ_ORDERED(limit->get_output(), expected_result);
  }
