...
namespace opossum {
    ...
    protected:
        void SetUp() override {
          ...
          _column_distributions = std::vector<ColumnDataDistribution>({ColumnDataDistribution::make_uniform_config(0.0, 100.0), ColumnDataDistribution::make_uniform_config(0.0, 100.0)});


          _wrapped_table = std::make_shared<CalibrationTableWrapper>(
                  _unwrapped_table,
                  _table_name,
