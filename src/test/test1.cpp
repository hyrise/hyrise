...
//    public:
//     void add_column(std::shared_ptr<base_attribute_vector> v) { _columns.push_back(v); }

//     std::shared_ptr<base_attribute_vector> get_column(int i) { return _columns[i]; }
...
//     long get_width() { return _columns.size(); }
// };
...
//         t->get_column(i)->append(123);
//         t->get_column(i)->append(123l);
//         t->get_column(i)->append(123.4f);
//         t->get_column(i)->append(123.3);
//         t->get_column(i)->append("123");
//         t->get_column(i)->append("123.3");
//     }
