...
TEST_F(AttributeStatisticsTest, Scaled) {
  auto attribute_statistics = AttributeStatistics<int32_t>{};
  attribute_statistics.set_histogram(GenericHistogram<int32_t>::with_single_bin(0, 100, 40, 20));
  attribute_statistics.set_min_max_filter(std::make_shared<MinMaxFilter<int32_t>>(0, 100));
  attribute_statistics.set_range_filter(std::make_shared<RangeFilter<int32_t>>(std::vector{std::pair<int32_t, int32_t>(0, 100)}));
  attribute_statistics.set_null_value_ratio(std::make_shared<NullValueRatioStatistics>(0.2f));
  attribute_statistics.set_distinct_value_count(std::make_shared<DistinctValueCount>(123));
...
TEST_F(AttributeStatisticsTest, Sliced) {
  auto attribute_statistics = AttributeStatistics<int32_t>{};
  attribute_statistics.set_histogram(GenericHistogram<int32_t>::with_single_bin(1, 100, 40, 20));
  attribute_statistics.set_min_max_filter(std::make_shared<MinMaxFilter<int32_t>>(0, 100));
  attribute_statistics.set_range_filter(std::make_shared<RangeFilter<int32_t>>(std::vector{std::pair<int32_t, int32_t>(0, 100)}));
  attribute_statistics.set_null_value_ratio(std::make_shared<NullValueRatioStatistics>(0.2f));
  attribute_statistics.set_distinct_value_count(std::make_shared<DistinctValueCount>(123));
