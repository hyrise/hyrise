...
TYPED_TEST(RangeFilterTest, ValueRangeTooLarge) {
  ...
  const auto test_vector =
      pmr_vector<TypeParam>{static_cast<TypeParam>(static_cast<CalcType>(0.9) * lowest), static_cast<TypeParam>(static_cast<CalcType>(0.8) * lowest),
                            static_cast<TypeParam>(static_cast<CalcType>(0.8) * max), static_cast<TypeParam>(static_cast<CalcType>(0.9) * max)};

  auto filter = RangeFilter<TypeParam>::build_filter(test_vector, 5);
  auto expected_range = Ranges{{static_cast<TypeParam>(static_cast<CalcType>(0.9) * lowest), static_cast<TypeParam>(static_cast<CalcType>(0.9) * max)}};
  ...
  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::Equals, static_cast<TypeParam>(lowest * static_cast<CalcType>(0.95))));
...
TYPED_TEST(RangeFilterTest, LargeValueRange) {
  ...
  const auto values =
      pmr_vector<TypeParam>{static_cast<TypeParam>(static_cast<CalcType>(0.4) * lowest),  static_cast<TypeParam>(static_cast<CalcType>(0.38) * lowest),
                            static_cast<TypeParam>(static_cast<CalcType>(0.36) * lowest), static_cast<TypeParam>(static_cast<CalcType>(0.30) * lowest),
                            static_cast<TypeParam>(static_cast<CalcType>(0.28) * lowest), static_cast<TypeParam>(static_cast<CalcType>(0.36) * max),
                            static_cast<TypeParam>(static_cast<CalcType>(0.38) * max),    static_cast<TypeParam>(static_cast<CalcType>(0.4) * max)};
  ...
  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::BetweenInclusive, static_cast<TypeParam>(static_cast<CalcType>(0.27) * lowest),
                                       static_cast<TypeParam>(static_cast<CalcType>(0.35) * max)));
  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::BetweenInclusive, static_cast<TypeParam>(static_cast<CalcType>(0.35) * lowest),
  ...
  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::Equals, static_cast<TypeParam>(static_cast<CalcType>(0.5) * lowest)));
  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::Equals, static_cast<TypeParam>(static_cast<CalcType>(0.5) * max)));
  ...
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::Equals, static_cast<TypeParam>(static_cast<CalcType>(0.4) * lowest)));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::Equals, static_cast<TypeParam>(static_cast<CalcType>(0.4) * max)));

  // With two gaps, the following should not exist.
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenInclusive, static_cast<TypeParam>(static_cast<CalcType>(0.4) * lowest),
