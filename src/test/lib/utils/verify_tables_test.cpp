...
#include "utils/check_table_equal.cpp"
...
TEST_F(TableVerificationTest, CaseInsensitiveColumns) {
  ...
  EXPECT_TRUE(check_table_equal(table_aa, table_aa_1, OrderSensitivity::No, TypeCmpMode::Lenient,
                                FloatComparisonMode::RelativeDifference));
  EXPECT_TRUE(check_table_equal(table_aa, table_aA, OrderSensitivity::No, TypeCmpMode::Lenient,
                                FloatComparisonMode::RelativeDifference));
  EXPECT_TRUE(check_table_equal(table_aa, table_Aa, OrderSensitivity::No, TypeCmpMode::Lenient,
                                FloatComparisonMode::RelativeDifference));
  EXPECT_TRUE(check_table_equal(table_aa, table_AA, OrderSensitivity::No, TypeCmpMode::Lenient,
                                FloatComparisonMode::RelativeDifference));
  EXPECT_FALSE(check_table_equal(table_aa, table_ab, OrderSensitivity::No, TypeCmpMode::Lenient,
                                 FloatComparisonMode::RelativeDifference));
}
