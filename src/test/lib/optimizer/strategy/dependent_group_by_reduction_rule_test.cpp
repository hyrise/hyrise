...
class DependentGroupByReductionRuleTest : public StrategyBaseTest {
 public:
  void SetUp() override {
    ...
    table_a->add_soft_table_key_constraint({{ColumnID{0}}, KeyConstraintType::PRIMARY_KEY});
    ...
    table_b->add_soft_table_key_constraint({{ColumnID{0}, ColumnID{1}}, KeyConstraintType::UNIQUE});
    ...
    table_c->add_soft_table_key_constraint({{ColumnID{0}, ColumnID{2}}, KeyConstraintType::PRIMARY_KEY});
    ...
    table_e->add_soft_table_key_constraint({{ColumnID{0}, ColumnID{1}}, KeyConstraintType::PRIMARY_KEY});
    table_e->add_soft_table_key_constraint({{ColumnID{2}}, KeyConstraintType::UNIQUE});
