...
TEST_F(LQPUtilsTest, VisitLQP) {
  ...
  expected_nodes[0]->set_input_left(expected_nodes[1]);
  expected_nodes[1]->set_input_left(expected_nodes[2]);
  expected_nodes[1]->set_input_right(expected_nodes[3]);
  expected_nodes[2]->set_input_left(node_a);
  expected_nodes[3]->set_input_left(node_a);
...
TEST_F(LQPUtilsTest, VisitLQPUpwards) {
  ...
  expected_nodes[4]->set_input_left(expected_nodes[3]);
  expected_nodes[3]->set_input_left(expected_nodes[1]);
  expected_nodes[3]->set_input_right(expected_nodes[2]);
  expected_nodes[1]->set_input_left(node_a);
  expected_nodes[2]->set_input_left(node_a);
