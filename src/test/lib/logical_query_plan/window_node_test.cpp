...
TEST_F(WindowNodeTest, Description) {
  ...
  auto frame_description =
      std::make_unique<FrameDescription>(FrameType::Rows, FrameBound{1, FrameBoundType::Preceding, false},
  ...
  frame_description =
      std::make_unique<FrameDescription>(FrameType::Rows, FrameBound{0, FrameBoundType::CurrentRow, false},
