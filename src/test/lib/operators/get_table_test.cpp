...
TEST_F(OperatorsGetTableTest, OperatorName) {
  auto get_table = std::make_shared<hyrise::GetTable>("int_int_float");

  EXPECT_EQ(get_table->name(), "GetTable");
}

TEST_F(OperatorsGetTableTest, Description) {
  auto get_table_a = std::make_shared<hyrise::GetTable>("int_int_float");
  ...
  auto get_table_b =
      std::make_shared<hyrise::GetTable>("int_int_float", std::vector{ChunkID{0}}, std::vector{ColumnID{1}});
...
TEST_F(OperatorsGetTableTest, PassThroughInvalidRowCount) {
  auto get_table_1 = std::make_shared<hyrise::GetTable>("int_int_float");
  get_table_1->execute();
  ...
  auto get_table_2 = std::make_shared<hyrise::GetTable>("int_int_float");
  get_table_2->execute();
...
TEST_F(OperatorsGetTableTest, PrunedChunks) {
  auto get_table = std::make_shared<hyrise::GetTable>("int_int_float", std::vector{ChunkID{0}, ChunkID{2}},
                                                       std::vector<ColumnID>{});
...
TEST_F(OperatorsGetTableTest, PrunedColumns) {
  auto get_table =
      std::make_shared<hyrise::GetTable>("int_int_float", std::vector<ChunkID>{}, std::vector{ColumnID{1}});
...
TEST_F(OperatorsGetTableTest, PrunedChunksCombined) {
  ...
  */
  ...
  auto get_table_2 =
      std::make_shared<hyrise::GetTable>("int_int_float", std::vector{ChunkID{0}}, std::vector<ColumnID>{});
...
TEST_F(OperatorsGetTableTest, AdaptOrderByInformation) {
  ...
  {
    auto get_table = std::make_shared<hyrise::GetTable>("int_int_float", std::vector<ChunkID>{},
  ...
  {
    auto get_table =
        std::make_shared<hyrise::GetTable>("int_int_float", std::vector<ChunkID>{}, std::vector<ColumnID>{});
    get_table->execute();
