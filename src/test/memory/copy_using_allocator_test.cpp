...
INSTANTIATE_TEST_CASE_P(
    CopyUsingAllocatorTestInstances, CopyUsingAllocatorTest,
    ::testing::ValuesIn(std::begin(all_segment_encoding_specs),
                        std::end(all_segment_encoding_specs)), [](const testing::TestParamInfo<EncodingTest::ParamType>& param_info) {  // TODO make global
