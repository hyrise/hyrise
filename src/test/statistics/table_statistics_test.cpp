...
class TableStatisticsTest : public BaseTest {
 protected:
  ...
  void SetUp() override {
    auto table = load_table("artifacts/test_data/tbl/int_float_double_string.tbl");
...
TEST_F(TableStatisticsTest, TwoColumnScan) {
  const auto int_int_float = load_table("artifacts/test_data/tbl/int_int_float.tbl");
