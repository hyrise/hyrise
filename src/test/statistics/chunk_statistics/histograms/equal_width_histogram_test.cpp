...
class EqualWidthHistogramTest : public BaseTest {
  void SetUp() override {
    _int_float4 = load_table("artifacts/test_data/tbl/int_float4.tbl");
    _float2 = load_table("artifacts/test_data/tbl/float2.tbl");
    _int_int4 = load_table("artifacts/test_data/tbl/int_int4.tbl");
    _string3 = load_table("artifacts/test_data/tbl/string3.tbl");
    _string_with_prefix = load_table("artifacts/test_data/tbl/string_with_prefix.tbl");
    _string_like_pruning = load_table("artifacts/test_data/tbl/string_like_pruning.tbl");
  }
...
TEST_F(EqualWidthHistogramTest, FloatBinBoundariesLargeValues) {
  ...
  const auto table = load_table("artifacts/test_data/tbl/float3.tbl");
  const auto hist =
