...
class AbstractHistogramIntTest : public BaseTest {
  void SetUp() override { _int_float4 = load_table("artifacts/test_data/tbl/int_float4.tbl"); }
...
class AbstractHistogramStringTest : public BaseTest {
  void SetUp() override {
    ...
    _int_string_like_containing2 = load_table("artifacts/test_data/tbl/int_string_like_containing2.tbl");
  }
