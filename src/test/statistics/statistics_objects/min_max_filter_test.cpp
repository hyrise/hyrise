...
TYPED_TEST(MinMaxFilterTest, CanPruneOnBounds) {
  ...
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenInclusive, {this->_before_range}, {this->_min_value}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenInclusive, {this->_min_value}, {this->_in_between}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenInclusive, {this->_in_between}, {this->_in_between2}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenInclusive, {this->_in_between2}, {this->_max_value}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenInclusive, {this->_max_value}, {this->_after_range}));

  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenLowerExclusive, {this->_before_range}, {this->_min_value}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenLowerExclusive, {this->_min_value}, {this->_in_between}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenLowerExclusive, {this->_in_between}, {this->_in_between2}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenLowerExclusive, {this->_in_between2}, {this->_max_value}));
  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::BetweenLowerExclusive, {this->_max_value}, {this->_after_range}));

  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::BetweenUpperExclusive, {this->_before_range}, {this->_min_value}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenUpperExclusive, {this->_min_value}, {this->_in_between}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenUpperExclusive, {this->_in_between}, {this->_in_between2}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenUpperExclusive, {this->_in_between2}, {this->_max_value}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenUpperExclusive, {this->_max_value}, {this->_after_range}));

  EXPECT_TRUE(filter->does_not_contain(PredicateCondition::BetweenExclusive, {this->_before_range}, {this->_min_value}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenExclusive, {this->_min_value}, {this->_in_between}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenExclusive, {this->_in_between}, {this->_in_between2}));
  EXPECT_FALSE(filter->does_not_contain(PredicateCondition::BetweenExclusive, {this->_in_between2}, {this->_max_value}));
