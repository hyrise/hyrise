...
class ColumnStatisticsTest : public BaseTest {
 protected:
  void SetUp() override {
    _table_with_different_column_types = load_table("artifacts/test_data/tbl/int_float_double_string.tbl");
    ...
    _table_uniform_distribution = load_table("artifacts/test_data/tbl/int_equal_distribution.tbl");
