...
class SortNodeTest : public BaseTest {
 protected:
  void SetUp() override {
    ...
    _sort_node = SortNode::make(std::vector<OrderByDefinition>{OrderByDefinition{_a_a, OrderByMode::Ascending}}, _table_node);
  }
...
TEST_F(SortNodeTest, ShallowEquals) {
  ...
  const auto other_sort_node_a = SortNode::make(std::vector<OrderByDefinition>{OrderByDefinition{_a_a, OrderByMode::Ascending}}, _table_node);
  const auto other_sort_node_b = SortNode::make(std::vector<OrderByDefinition>{OrderByDefinition{_a_a, OrderByMode::Ascending}, OrderByDefinition{_a_b, OrderByMode::Ascending}}, _table_node);
  const auto other_sort_node_c = SortNode::make(std::vector<OrderByDefinition>{OrderByDefinition{_a_b, OrderByMode::Ascending}}, _table_node);
