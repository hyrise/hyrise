...
class StoredTableNodeTest : public BaseTest {
 protected:
  void SetUp() override {
    StorageManager::get().add_table("t_a", load_table("artifacts/test_data/tbl/int_float.tbl"));
    StorageManager::get().add_table("t_b", load_table("artifacts/test_data/tbl/int_float.tbl"));
