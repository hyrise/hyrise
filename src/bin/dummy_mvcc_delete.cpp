...
void DummyMvccDelete::_clean_up_chunk(const std::string &table_name, opossum::ChunkID chunk_id) {
...
bool DummyMvccDelete::_delete_chunk_logically(const std::string& table_name, ChunkID chunk_id) {
...
bool DummyMvccDelete::_delete_chunk_physically(const std::string& table_name, ChunkID chunk_id) {
  const auto& table = StorageManager::get().get_table(table_name);
 ...
 */
std::shared_ptr<const Table> DummyMvccDelete::_get_referencing_table(const std::string& table_name, const ChunkID chunk_id) {
...
void DummyMvccDelete::_process_physical_delete_queue() {
  bool success = true;
