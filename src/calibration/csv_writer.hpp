...
namespace opossum {
    ...
    public:
      ...
      void set_value(const std::string& key, const T& value){
        ...
        DebugAssert(
                std::find(_headers.begin(), _headers.end(), key) != _headers.end(),
                "\nCSV Writer ERROR: Added a value '" + stringified_value + "' for an unknown column '" + key + "' for file '" + _file_path + "'\n" +
        ...
        DebugAssert(
                stringified_value.find(_delimiter) == std::string::npos,
                "\nCSV Writer ERROR: Found delimiter '" + _delimiter + "' in value '" + stringified_value +"' of '" + key + "' for file '" + _file_path + "'\n" +
