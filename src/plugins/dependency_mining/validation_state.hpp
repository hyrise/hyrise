...
struct ValidationState {
  ...
  explicit ValidationState(const bool no_limits, const int64_t init_max_validations = 0, const bool use_time_for_validation = false, const Duration init_max_duration = Duration{});
