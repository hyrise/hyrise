...
TaskVector NewOrderRefImpl::get_create_order_tasks(const int32_t d_next_o_id, const int32_t d_id, const int32_t w_id,
  ...
  opossum::ChunkColumnList columns;
  columns.emplace_back(create_single_value_column<int32_t>(d_next_o_id));
  columns.emplace_back(create_single_value_column<int32_t>(d_id));
  columns.emplace_back(create_single_value_column<int32_t>(w_id));
  columns.emplace_back(create_single_value_column<int32_t>(c_id));
  columns.emplace_back(create_single_value_column<int32_t>(o_entry_d));
  columns.emplace_back(create_single_value_column<int32_t>(o_carrier_id));
  columns.emplace_back(create_single_value_column<int32_t>(o_ol_cnt));
  columns.emplace_back(create_single_value_column<int32_t>(o_all_local));
  new_table->add_chunk_new(columns);
...
TaskVector NewOrderRefImpl::get_create_new_order_tasks(const int32_t o_id, const int32_t d_id, const int32_t w_id) {
  ...
  opossum::ChunkColumnList columns;
  columns.emplace_back(create_single_value_column<int32_t>(o_id));
  columns.emplace_back(create_single_value_column<int32_t>(d_id));
  columns.emplace_back(create_single_value_column<int32_t>(w_id));
  new_table->add_chunk_new(columns);
...
TaskVector NewOrderRefImpl::get_create_order_line_tasks(const int32_t ol_o_id, const int32_t ol_d_id,
  ...
  opossum::ChunkColumnList columns;
  columns.emplace_back(create_single_value_column<int32_t>(ol_o_id));
  columns.emplace_back(create_single_value_column<int32_t>(ol_d_id));
  columns.emplace_back(create_single_value_column<int32_t>(ol_w_id));
  columns.emplace_back(create_single_value_column<int32_t>(ol_number));
  columns.emplace_back(create_single_value_column<int32_t>(ol_i_id));
  columns.emplace_back(create_single_value_column<int32_t>(ol_supply_w_id));
  columns.emplace_back(create_single_value_column<int32_t>(ol_delivery_d));
  columns.emplace_back(create_single_value_column<int32_t>(ol_quantity));
  columns.emplace_back(create_single_value_column<float>(ol_amount));
  columns.emplace_back(create_single_value_column<std::string>(ol_dist_info));
  new_table->add_chunk_new(columns);
