...
void TPCHTableGenerator::_add_constraints(
  ...
  unique_constraint(part_table, {"p_name", "p_retailprice"});
  unique_constraint(part_table, {"p_name", "p_type"});
  unique_constraint(part_table, {"p_name", "p_size"});
  unique_constraint(part_table, {"p_name", "p_container"});
  unique_constraint(part_table, {"p_name", "p_brand"});
  unique_constraint(part_table, {"p_name", "p_mfgr"});
  unique_constraint(part_table, {"p_type", "p_retailprice", "p_comment"});
  unique_constraint(part_table, {"p_size", "p_retailprice", "p_comment"});
  unique_constraint(part_table, {"p_brand", "p_retailprice", "p_comment"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_comment", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_comment", "l_partkey"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_comment", "l_suppkey"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_receiptdate", "l_comment"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_shipdate", "l_comment"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_commitdate", "l_comment"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_comment", "l_quantity"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_comment", "l_discount"});
  unique_constraint(lineitem_table, {"l_receiptdate", "l_comment", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_shipdate", "l_comment", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_commitdate", "l_comment", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_receiptdate", "l_comment", "l_partkey"});
  unique_constraint(lineitem_table, {"l_shipdate", "l_comment", "l_partkey"});
  unique_constraint(lineitem_table, {"l_commitdate", "l_comment", "l_partkey"});
  unique_constraint(lineitem_table, {"l_receiptdate", "l_comment", "l_suppkey"});
  unique_constraint(lineitem_table, {"l_shipdate", "l_comment", "l_suppkey"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_suppkey", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_receiptdate", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_shipdate", "l_extendedprice"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_receiptdate", "l_partkey"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_shipdate", "l_partkey"});
  unique_constraint(lineitem_table, {"l_orderkey", "l_linenumber"});
  ...
  unique_constraint(supplier_table, {"s_comment"});
  unique_constraint(partsupp_table, {"ps_partkey", "ps_comment"});
  unique_constraint(partsupp_table, {"ps_supplycost", "ps_comment"});
  unique_constraint(partsupp_table, {"ps_suppkey", "ps_comment"});
  unique_constraint(partsupp_table, {"ps_availqty", "ps_comment"});
  unique_constraint(partsupp_table, {"ps_partkey", "ps_availqty", "ps_supplycost"});
  unique_constraint(partsupp_table, {"ps_partkey", "ps_suppkey"});
  unique_constraint(partsupp_table, {"ps_suppkey", "ps_availqty", "ps_supplycost"});
  unique_constraint(orders_table, {"o_orderkey"});
  unique_constraint(orders_table, {"o_totalprice", "o_comment"});
  unique_constraint(orders_table, {"o_custkey", "o_comment"});
  unique_constraint(orders_table, {"o_orderdate", "o_clerk", "o_comment"});
  unique_constraint(orders_table, {"o_custkey", "o_totalprice", "o_orderdate"});
  ...
  unique_constraint(customer_table, {"c_acctbal", "c_comment"});
  unique_constraint(customer_table, {"c_nationkey", "c_mktsegment", "c_comment"});

  order_constraint(region_table, {"r_regionkey"}, {"r_name"});
