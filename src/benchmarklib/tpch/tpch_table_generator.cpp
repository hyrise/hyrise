...
// clang-format off
const auto customer_column_types = boost::hana::tuple <not_optional<int32_t>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<int32_t>, not_optional<pmr_string>, not_optional<float>, not_optional<pmr_string>, not_optional<pmr_string>>(); // NOLINT
...
const auto order_column_types = boost::hana::tuple <not_optional<int32_t>, not_optional<int32_t>, not_optional<pmr_string>, not_optional<float>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<int32_t>, not_optional<pmr_string>>(); // NOLINT
...
const auto lineitem_column_types = boost::hana::tuple <not_optional<int32_t>, not_optional<int32_t>, not_optional<int32_t>, not_optional<int32_t>, not_optional<float>, not_optional<float>, not_optional<float>, not_optional<float>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>>(); // NOLINT
...
const auto part_column_types = boost::hana::tuple <not_optional<int32_t>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<int32_t>, not_optional<pmr_string>, not_optional<float>, not_optional<pmr_string>>(); // NOLINT
...
const auto partsupp_column_types = boost::hana::tuple<not_optional<int32_t>, not_optional<int32_t>, not_optional<int32_t>, not_optional<float>, not_optional<pmr_string>>(); // NOLINT
const auto partsupp_column_names = boost::hana::make_tuple("ps_partkey", "ps_suppkey", "ps_availqty", "ps_supplycost", "ps_comment"); // NOLINT

const auto supplier_column_types = boost::hana::tuple<not_optional<int32_t>, not_optional<pmr_string>, not_optional<pmr_string>, not_optional<int32_t>, not_optional<pmr_string>, not_optional<float>, not_optional<pmr_string>>(); // NOLINT
...
const auto nation_column_types = boost::hana::tuple<not_optional<int32_t>, not_optional<pmr_string>, not_optional<int32_t>, not_optional<pmr_string>>(); // NOLINT
const auto nation_column_names = boost::hana::make_tuple("n_nationkey", "n_name", "n_regionkey", "n_comment"); // NOLINT

const auto region_column_types = boost::hana::tuple<not_optional<int32_t>, not_optional<pmr_string>, not_optional<pmr_string>>(); // NOLINT
