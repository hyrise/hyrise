...
// clang-format off
const auto customer_column_types = boost::hana::tuple      <int32_t,    pmr_string,  pmr_string,  int32_t,       pmr_string,  double,       pmr_string,     pmr_string>();  // NOLINT
...
const auto order_column_types = boost::hana::tuple      <int32_t,     int32_t,     pmr_string,      double,          pmr_string,    pmr_string,        pmr_string,  int32_t,          pmr_string>();  // NOLINT
...
const auto lineitem_column_types = boost::hana::tuple      <int32_t,     int32_t,     int32_t,     int32_t,        double,        double,             double,        double,   pmr_string,     pmr_string,     pmr_string,   pmr_string,     pmr_string,      pmr_string,       pmr_string,   pmr_string>();  // NOLINT
...
const auto part_column_types = boost::hana::tuple      <int32_t,    pmr_string,  pmr_string,  pmr_string,  pmr_string,  int32_t,  pmr_string,    double,        pmr_string>();  // NOLINT
...
const auto partsupp_column_types = boost::hana::tuple<     int32_t,      int32_t,      int32_t,       double,           pmr_string>();  // NOLINT
const auto partsupp_column_names = boost::hana::make_tuple("ps_partkey", "ps_suppkey", "ps_availqty", "ps_supplycost", "ps_comment");  // NOLINT

const auto supplier_column_types = boost::hana::tuple<     int32_t,     pmr_string,  pmr_string,  int32_t,       pmr_string,  double,       pmr_string>();  // NOLINT
