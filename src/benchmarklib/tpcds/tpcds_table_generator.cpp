...
const auto customer_address_column_types = boost::hana::tuple<tpcds_key_t, pmr_string, std::optional<int32_t>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<int32_t>, std::optional<pmr_string>, std::optional<int32_t>, std::optional<pmr_string>>(); // NOLINT
...
const auto promotion_column_types = boost::hana::tuple<std::optional<tpcds_key_t>, pmr_string, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, float, int32_t, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string>(); // NOLINT
...
const auto store_column_types = boost::hana::tuple<std::optional<tpcds_key_t>, pmr_string, pmr_string, pmr_string, std::optional<tpcds_key_t>, pmr_string, int32_t, int32_t, pmr_string, pmr_string, int32_t, pmr_string, pmr_string, pmr_string, std::optional<tpcds_key_t>, pmr_string, std::optional<tpcds_key_t>, pmr_string, int32_t, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, int32_t, pmr_string, int32_t, float>(); // NOLINT
...
const auto warehouse_column_types = boost::hana::tuple<std::optional<tpcds_key_t>, pmr_string, pmr_string, int32_t, int32_t, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, int32_t, pmr_string, int32_t>(); // NOLINT
...
const auto web_returns_column_types = boost::hana::tuple<std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, int32_t, float, float, float, float, float, float, float, float, float>(); // NOLINT
...
const auto web_site_column_types = boost::hana::tuple<std::optional<tpcds_key_t>, pmr_string, pmr_string, pmr_string, pmr_string, std::optional<tpcds_key_t>, std::optional<tpcds_key_t>, pmr_string, pmr_string, int32_t, pmr_string, pmr_string, pmr_string, int32_t, pmr_string, int32_t, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, int32_t, pmr_string, int32_t, float>(); // NOLINT
  ...
  // customer
  {
    ...
    for (auto i = ds_key_t{0}; i < customer_count; i++) {
      ...
      customer_builder.append_row(
          ...
          resolve_integer<C_BIRTH_YEAR>(customer.c_birth_year),
          resolve_string<C_BIRTH_COUNTRY>(customer.c_birth_country), resolve_string<C_LOGIN>(customer.c_login),
          resolve_string<C_EMAIL_ADDRESS>(customer.c_email_address),
  ...
  // customer address
  {
    ...
    for (auto i = ds_key_t{0}; i < customer_address_count; i++) {
      ...
      customer_address_builder.append_row(
          ...
          resolve_integer<CA_ADDRESS_ZIP>(customer_address.ca_address.zip),
          resolve_string<CA_ADDRESS_COUNTRY>(customer_address.ca_address.country),
          resolve_integer<CA_ADDRESS_GMT_OFFSET>(customer_address.ca_address.gmt_offset),
  ...
  // store
  {
    ...
    for (auto i = ds_key_t{0}; i < store_count; i++) {
      ...
      store_builder.append_row(resolve_key(store.store_sk), store.store_id, resolve_date_id(store.rec_start_date_id),
                               ...
                               store.company_name, store.address.street_num, resolve_street_name(store.address),
  ...
  // warehouse
  {
    ...
    for (auto i = ds_key_t{0}; i < warehouse_count; i++) {
      ...
      warehouse_builder.append_row(
          ...
          warehouse.w_warehouse_sq_ft, warehouse.w_address.street_num, resolve_street_name(warehouse.w_address),
  ...
  // web site
  {
    ...
    for (auto i = ds_key_t{0}; i < web_site_count; i++) {
      ...
      web_site_builder.append_row(
          ...
          web_site.web_company_name, web_site.web_address.street_num, resolve_street_name(web_site.web_address),
          web_site.web_address.street_type, web_site.web_address.suite_num, web_site.web_address.city,
          web_site.web_address.county, web_site.web_address.state, web_site.web_address.zip,
          web_site.web_address.country, web_site.web_address.gmt_offset, decimal_to_float(web_site.web_tax_percentage));
    }
