...
const auto inventory_column_types = boost::hana::tuple<int64_t, int64_t, int64_t, std::optional<int32_t>>(); // NOLINT
...
const auto item_column_types = boost::hana::tuple<int64_t, pmr_string, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<float>, std::optional<float>, std::optional<int64_t>, std::optional<pmr_string>, std::optional<int64_t>, std::optional<pmr_string>, std::optional<int64_t>, std::optional<pmr_string>, std::optional<int64_t>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<pmr_string>, std::optional<int64_t>, std::optional<pmr_string>>(); // NOLINT
...
const auto web_site_column_types = boost::hana::tuple<std::optional<int64_t>, pmr_string, pmr_string, pmr_string, pmr_string, std::optional<int64_t>, std::optional<int64_t>, pmr_string, pmr_string, int32_t, pmr_string, pmr_string, pmr_string, int32_t, pmr_string, int32_t, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, pmr_string, int32_t, pmr_string, int32_t, float>(); // NOLINT
