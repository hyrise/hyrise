...
cxxopts::Options BenchmarkRunner::get_basic_cli_options(const std::string& benchmark_name) {
  ...
  cli_options.add_options()
    ...
    ("e,encoding", "Specify Chunk encoding as a string or as a JSON config file (for more detailed configuration, see --full_help). String options: " + all_encoding_options())  // NOLINT(whitespace/line_length)
