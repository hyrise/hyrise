...
cxxopts::Options BenchmarkRunner::get_basic_cli_options(const std::string& benchmark_name) {
  ...
  cli_options.add_options()
    ...
    ("chunk_indexes", "Create chunk_indexes (where defined by benchmark)", cxxopts::value<bool>()->default_value("false"))  // NOLINT
    ("table_indexes", "Create table_indexes (where defined by benchmark)", cxxopts::value<bool>()->default_value("false"))  // NOLINT
