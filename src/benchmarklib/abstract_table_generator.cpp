...
void AbstractTableGenerator::generate_and_store() {
  ...
  if (_benchmark_config->cache_binary_tables) {
    ...
    //std::cout << "- Writing tables into binary files done (" << format_duration(metrics.binary_caching_duration) << ")"<< std::endl;
  }
  ...
  //std::cout << "- Adding Tables to StorageManager and generating statistics done ("<< format_duration(metrics.store_duration) << ")" << std::endl;
}
