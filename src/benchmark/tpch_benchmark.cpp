...
int main(int argc, char* argv[]) {
  ...
  // TODO: Enable support for queries that contain multiple statements requiring execution
  // TODO: Currently TPC-H 15 also breaks without scheduler, because we call get_tasks() there as well now.
