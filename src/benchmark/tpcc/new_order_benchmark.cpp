...
#include "../../benchmark-libs/tpcc/constants.hpp"
...
class TPCCNewOrderBenchmark : public TPCCBenchmarkFixture {
 public:
  void benchmark_new_order(benchmark::State &state, AbstractNewOrderImpl &impl) {
    clear_cache();
    ...
    while (state.KeepRunning()) {
      ...
      params.o_entry_d = 0; // TODO: Real data
