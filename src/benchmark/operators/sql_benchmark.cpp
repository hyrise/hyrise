...
class SQLBenchmark : public BenchmarkBasicFixture {
 public:
  void SetUp(benchmark::State& st) override {
    ...
    storage_manager.add_table("customer", load_table("src/test/tables/tpch/tpch-minimal/customer.tbl", Chunk::MAX_SIZE));
    storage_manager.add_table("lineitem", load_table("src/test/tables/tpch/tpch-minimal/lineitem.tbl", Chunk::MAX_SIZE));
    storage_manager.add_table("orders", load_table("src/test/tables/tpch/tpch-minimal/orders.tbl", Chunk::MAX_SIZE));
  }
