...
///////////////////////////////
constexpr auto SEGMENT_META_DATA_FILE = "../../out/400mio/segment_meta_data_int_index.csv";
constexpr auto INDEX_META_DATA_FILE = "../../out/400mio/index_meta_data_int_index.csv";
