...
ModelCalibrationBenchmark::ModelCalibrationBenchmark(CalibrationType calibration_type,
                                                                   nlohmann::json description)
    : _calibration_type(calibration_type), _description(std::move(description)), _context(_description["context"]) {}

void ModelCalibrationBenchmark::run() {
...
void ModelCalibrationBenchmark::_output_as_csv(const nlohmann::json& data) {
...
void ModelCalibrationBenchmark::_generate_statistics(nlohmann::json& benchmark,
...
nlohmann::json ModelCalibrationBenchmark::_value_or_default(const nlohmann::json& benchmark,
