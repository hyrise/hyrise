...
class CalibrationQueryGenerator {
 ...
 private:
  ...
  static const std::string _generate_select_columns(
    ...
    static const std::optional<std::pair<std::pair<std::string, CalibrationColumnSpecification>, std::pair<std::string, CalibrationColumnSpecification>>> _generate_join_columns(
