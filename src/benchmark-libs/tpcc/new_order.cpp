...
TaskVector NewOrderRefImpl::get_get_customer_and_warehouse_tax_rate_tasks(const int32_t w_id, const int32_t d_id,
  ...
  const auto proj = std::make_shared<opossum::Projection>(join,
  opossum::Projection::ColumnExpressions({
    opossum::ExpressionNode::create_column_reference("C_DISCOUNT"),
...
TaskVector NewOrderRefImpl::get_get_district_tasks(const int32_t d_id, const int32_t w_id) {
  ...
  const auto proj = std::make_shared<opossum::Projection>(ts2, opossum::Projection::ColumnExpressions({
                                                                                                        opossum::ExpressionNode::create_column_reference("D_NEXT_O_ID"),
...
TaskVector NewOrderRefImpl::get_increment_next_order_id_tasks(const int32_t d_id, const int32_t d_w_id,
  ...
  const auto original_rows = std::make_shared<opossum::Projection>(ts2, opossum::Projection::ColumnExpressions({
                                                                                                                 opossum::ExpressionNode::create_column_reference("D_NEXT_O_ID")}));
...
TaskVector NewOrderRefImpl::get_get_item_info_tasks(const int32_t ol_i_id) {
  ...
  const auto proj = std::make_shared<opossum::Projection>(ts, opossum::Projection::ColumnExpressions({
    opossum::ExpressionNode::create_column_reference("I_PRICE"),
...
TaskVector NewOrderRefImpl::get_get_stock_info_tasks(const int32_t ol_i_id, const int32_t ol_supply_w_id,
  ...
  const auto proj = std::make_shared<opossum::Projection>(ts2, opossum::Projection::ColumnExpressions({
opossum::ExpressionNode::create_column_reference("S_QUANTITY"),
...
TaskVector NewOrderRefImpl::get_update_stock_tasks(const int32_t s_quantity, const int32_t ol_i_id,
  ...
  const auto updated_rows = std::make_shared<opossum::Projection>(ts2, opossum::Projection::ColumnExpressions({
    opossum::ExpressionNode::create_literal({s_quantity}, "fix")}));
