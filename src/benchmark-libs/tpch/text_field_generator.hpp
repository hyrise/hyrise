...
class TextFieldGenerator {
 public:
  ...
  explicit TextFieldGenerator(benchmark_utilities::RandomGenerator random_generator)
      : _random_gen(random_generator), _text(TpchGrammar(random_generator).random_text(300e6)) {}
  ...
  std::string phone_number(size_t nationkey) {
    std::stringstream ss;
    ss << nationkey + 10 << "-" << _random_gen.random_number(100, 999) << "-" << _random_gen.random_number(100, 999);
