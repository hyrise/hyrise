...
class OperatorTask : public AbstractTask {
 public:
  ...
  OperatorTask(std::shared_ptr<AbstractOperator> op, CleanupTemporaries cleanup_temporaries, SchedulePriority priority = SchedulePriority::Default, bool stealable = true);
