...
class JobTask : public AbstractTask {
 public:
  explicit JobTask(const std::function<void()>& fn, SchedulePriority priority = SchedulePriority::JobTask, bool stealable = true) : AbstractTask(priority, stealable), _fn(fn) {}
