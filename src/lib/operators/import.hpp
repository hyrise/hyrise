...
class Import : public AbstractReadOnlyOperator {
 public:
   ...
   * @param table_encoding Optional. Encoding of the imported table. If not present the default encoding is used.
 ...
 private:
  ...
  FileType _file_type;
  const std::optional<EncodingType> _table_encoding;
