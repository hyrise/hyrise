...
class Import : public AbstractReadOnlyOperator {
 public:
   ...
   * @param table_encoding Optional. Encoding of the imported table.
  ...
  explicit Import(const std::string& init_filename, const std::string& tablename,
                  ...
                  const EncodingType table_encoding = EncodingType::Unencoded, const std::optional<CsvMeta>& csv_meta = std::nullopt);
