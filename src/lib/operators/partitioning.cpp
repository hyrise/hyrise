...
std::shared_ptr<Table> Partitioning::_create_partitioned_table_copy(
    std::shared_ptr<const Table> table_to_be_partitioned) {
...
void Partitioning::_copy_table_content(const std::shared_ptr<const Table> source,
