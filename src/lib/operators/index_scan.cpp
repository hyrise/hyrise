...
IndexScan::IndexScan(const std::shared_ptr<const AbstractOperator>& op, const SegmentIndexType index_type,
    ...
    : AbstractReadOnlyOperator{OperatorType::IndexScan, op},
