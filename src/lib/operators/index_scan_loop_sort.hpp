 ...
 */
class IndexScanLoopSort : public AbstractReadOnlyOperator {
  friend class LQPTranslatorTest;

 public:
  IndexScanLoopSort(const std::shared_ptr<const AbstractOperator>& in, const SegmentIndexType index_type,
