  ...
  for (const auto& unaggregated_column : unaggregated_columns) {
    ...
    resolve_data_type(input_table->column_data_type(input_column_id), [&](const auto typed_value) {
      ...
      for (const auto& result : results) {
        ...
        // results was generated by grouping the input data. While it might point to rows that contain NULL values, no
        // new NULL values should have been added.
      ...
      output_segments[output_column_id] = value_segment;
    });
  }
}
