...
static cl::opt<bool> EnableNoAliasConversion("opossum-enable-noalias-to-md-conversion", cl::init(true), cl::Hidden,
                                             cl::desc("Convert noalias attributes to metadata during inlining."));

static cl::opt<bool> PreserveAlignmentAssumptions("opossum-preserve-alignment-assumptions-during-inlining",
...
bool opossum::InlineFunction(CallSite CS, InlineFunctionInfo& IFI, AAResults* CalleeAAR, bool InsertLifetime,
  ...
  {  // Scope to destroy VMap after cloning.
    ...
    opossum::CloneAndPruneFunctionInto(Caller, CalledFunc, VMap,
                                 /*ModuleLevelChanges=*/false, Returns, ".i", &InlinedFunctionInfo, TheCall, Context);
