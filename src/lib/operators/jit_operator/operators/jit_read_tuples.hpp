...
class JitReadTuples : public AbstractJittable {
 ...
 public:
  ...
  JitTupleValue add_input_column(const DataType data_type, const bool is_nullable, const CxlumnID cxlumn_id);
  ...
  std::optional<CxlumnID> find_input_column(const JitTupleValue& tuple_value) const;
