...
JitFilter::JitFilter(const std::shared_ptr<JitExpression>& expression) : _expression{expression} {
...
std::shared_ptr<JitExpression> JitFilter::expression() { return _expression; }
