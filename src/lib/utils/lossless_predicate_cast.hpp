...
namespace opossum {
  ...
  // fail. However, `float(a) > double(3.1)` can be reformulated as `float(a) >= double(3.099999904632568359375)`.
  ...
  std::optional<std::pair<PredicateCondition, Output>> lossless_predicate_cast(const PredicateCondition condition, const Input input) {
