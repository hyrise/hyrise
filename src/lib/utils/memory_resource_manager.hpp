...
struct ResourceRecord {
  ...
  ResourceRecord(const OperatorType init_operator_type, const std::string& init_operator_data_structure,
    std::unique_ptr<TrackingMemoryResource> init_resource_pointer)
      : operator_type{init_operator_type}, operator_data_structure{init_operator_data_structure},
      resource_pointer{std::move(init_resource_pointer)} {}
};
