// Backport for the fix of https://github.com/boostorg/hana/issues/446
// Remove this once Ubuntu finally has boost 1.71
  ...
  return [perfect - capture](auto&& x1) {
    return [perfect - capture](auto&& x2) {
      ... return [perfect - capture](auto&& xn) -> decltype(auto) {
        return forwarded(f)(forwarded(x1), forwarded(x2), ..., forwarded(xn));
      };
    };
  };
};
