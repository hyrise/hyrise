...
//}
//
//void ColumnIdentifierLookup::add(const SQLIdentifier& qualified_column_name,
//                           const std::shared_ptr<AbstractExpression>& expression) {
...
//}
//
//std::vector<std::shared_ptr<ExpressionLookupEntry>> ColumnIdentifierLookup::get(const SQLIdentifier& qualified_column_name) const {
