...
struct SQLPipelineControlBlock {
  SQLPipelineControlBlock(const UseMvcc use_mvcc, const std::shared_ptr<TransactionContext>& transaction_context,
    ...
    Assert(!transaction_context || use_mvcc == UseMvcc::Yes,
