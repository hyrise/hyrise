...
/**
 * Cxlumn-like data structure storing visibility information
...
struct MvccData {
 ...
 public:
  ...
  /**
   * Grows all mvcc data by the given delta
   *
 ...
 private:
   ...
   * Locked for shared ownership when MVCC data of a Chunk is accessed
