...
typename PartialHashIndexImpl<DataType>::IteratorPair PartialHashIndexImpl<DataType>::range_equals(
  ...
  auto end = begin;
  return std::make_pair(TableIndexMapIterator<DataType>::wrap(begin), TableIndexMapIterator<DataType>::wrap(++end));
}
