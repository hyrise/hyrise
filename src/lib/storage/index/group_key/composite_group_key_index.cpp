...
CompositeGroupKeyIndex::CompositeGroupKeyIndex(const std::vector<BaseColumnCSPtr>& indexed_columns)
...
std::vector<BaseColumnCSPtr> CompositeGroupKeyIndex::_get_index_columns() const {
  auto result = std::vector<BaseColumnCSPtr>();
