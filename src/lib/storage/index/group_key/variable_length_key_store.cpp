...
VariableLengthKeyConstProxy VariableLengthKeyStore::operator[](ChunkOffset position) const {
  auto self = const_cast<VariableLengthKeyStore*>(this);  // NOTIDY(cppcoreguidelines-pro-type-const-cast)
...
VariableLengthKeyStore::const_iterator VariableLengthKeyStore::cbegin() const {
  auto self = const_cast<VariableLengthKeyStore*>(this);  // NOTIDY(cppcoreguidelines-pro-type-const-cast) (see above)
