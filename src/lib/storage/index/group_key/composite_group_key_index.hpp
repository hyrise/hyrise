...
class CompositeGroupKeyIndex : public BaseIndex {
 ...
 public:
  ...
  explicit CompositeGroupKeyIndex(const std::vector<BaseColumnCSPtr>& indexed_columns);
 ...
 private:
  ...
  std::vector<BaseColumnCSPtr> _get_index_columns() const final;
 ...
 private:
  ...
  std::vector<BaseDictionaryColumnCSPtr> _indexed_columns;
