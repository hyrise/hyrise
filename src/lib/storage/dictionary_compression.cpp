...
std::shared_ptr<BaseColumn> DictionaryCompression::compress_column(DataType data_type,
                                                                   const std::shared_ptr<BaseColumn>& column, ColumnEncodingType encoding_type) {
...
void DictionaryCompression::compress_chunk(const std::vector<DataType>& column_types, Chunk& chunk, ColumnEncodingType encoding_type) {
...
void DictionaryCompression::compress_chunks(Table& table, const std::vector<ChunkID>& chunk_ids, ColumnEncodingType encoding_type) {
...
void DictionaryCompression::compress_table(Table& table, ColumnEncodingType encoding_type) {
