...
{
 public:
  class Iterator : public std::iterator<std::input_iterator_tag, NullableColumnValue<ValueID>, std::ptrdiff_t, NullableColumnValue<ValueID> *, NullableColumnValue<ValueID>> {
   public:
  ...
  class ReferencedIterator : public std::iterator<std::input_iterator_tag, NullableColumnValue<ValueID>, std::ptrdiff_t, NullableColumnValue<ValueID> *, NullableColumnValue<ValueID>> {
   public:
    using ChunkOffsetsIterator = std::vector<std::pair<ChunkOffset, ChunkOffset>>::const_iterator;

   public:
    explicit ReferencedIterator(const BaseAttributeVector & attribute_vector, const ChunkOffsetsIterator & chunk_offsets_it)
