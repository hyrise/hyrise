...
std::unique_ptr<const AbstractCompressedVector> FixedWidthIntegerCompressor::compress(
...
std::unique_ptr<AbstractVectorCompressor> FixedWidthIntegerCompressor::create_new() const {
...
std::unique_ptr<AbstractCompressedVector> FixedWidthIntegerCompressor::_compress_using_max_value(
...
std::unique_ptr<AbstractCompressedVector> FixedWidthIntegerCompressor::_compress_using_uint_type(
