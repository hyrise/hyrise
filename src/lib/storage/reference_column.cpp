...
ReferenceColumn::ReferenceColumn(const std::shared_ptr<const Table> referenced_table,
    ...
    : BaseColumn(referenced_table->column_type(referenced_column_id)), _referenced_table(referenced_table), _referenced_column_id(referenced_column_id), _pos_list(pos) {
#if IS_DEBUG
