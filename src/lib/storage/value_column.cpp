...
template <typename T>
ValueColumn<T>::ValueColumn(std::vector<T>& values, const PolymorphicAllocator<T>& alloc) : BaseValueColumn(data_type_from_type<T>()), _values(values, alloc) {}

template <typename T>
ValueColumn<T>::ValueColumn(std::vector<T>& values, std::vector<bool>& null_values, const PolymorphicAllocator<T>& alloc) : BaseValueColumn(data_type_from_type<T>()), _values(values, alloc), _null_values(null_values, alloc) {}
