...
void Table::inc_invalid_row_count(uint32_t count) { _approx_invalid_row_count += count; }
...
uint32_t Table::approx_valid_row_count() const { return row_count() - _approx_invalid_row_count; }
