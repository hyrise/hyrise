 ...
 *
 * TuningChoices are generated by AbstractTuningEvaluators in a Tuner instance
...
class TuningChoice {
 public:
   ...
   * among TuningChoices generated by compatible AbstractTuningEvaluator implementations.
   */
