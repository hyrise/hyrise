...
class AbstractCardinalityEstimator {
 public:
  ...
  virtual std::shared_ptr<AbstractCardinalityEstimator> clone_with_cache(const std::shared_ptr<CardinalityEstimationCache>& cardinality_estimation_cache) const = 0;
