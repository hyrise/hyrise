...
inline void boost_promise_invoke_and_set(boost::promise<T>& p,
...
inline void boost_promise_invoke_and_set(boost::promise<void>& p,
    F& f, BOOST_ASIO_MOVE_ARG(Args)... args)
{
#if !defined(BOOST_ASIO_NO_EXCEPTIONS)
  try
...
{
public:
  boost_promise_invoker(const shared_ptr<boost::promise<T> >& p,
...
{
public:
  explicit boost_promise_executor(const shared_ptr<boost::promise<T> >& p)
    : p_(p)
  {
  }
  ...
  void post(BOOST_ASIO_MOVE_ARG(F) f, const A& a) const
  {
    system_executor().post(
        boost_promise_invoker<T, F>(p_, BOOST_ASIO_MOVE_CAST(F)(f)), a);
  }
  ...
  friend bool operator==(const boost_promise_executor& a,
      const boost_promise_executor& b) BOOST_ASIO_NOEXCEPT
  {
    return a.p_ == b.p_;
  }
...
class boost_promise_handler_0
  : public boost_promise_creator<void>
{
public:
  void operator()()
  {
...
class boost_promise_handler_ec_0
  : public boost_promise_creator<void>
{
public:
...
class boost_promise_handler_ex_0
  : public boost_promise_creator<void>
{
public:
...
template <typename T>
class boost_promise_handler_1
  : public boost_promise_creator<T>
{
public:
...
template <typename T>
class boost_promise_handler_ec_1
  : public boost_promise_creator<T>
{
public:
  template <typename Arg>
...
template <typename T>
class boost_promise_handler_ex_1
  : public boost_promise_creator<T>
{
public:
  template <typename Arg>
...
template <typename T>
class boost_promise_handler_ec_n
  : public boost_promise_creator<T>
{
public:
#if defined(BOOST_ASIO_HAS_VARIADIC_TEMPLATES)
...
template <typename T>
class boost_promise_handler_ex_n
  : public boost_promise_creator<T>
{
public:
#if defined(BOOST_ASIO_HAS_VARIADIC_TEMPLATES)
...
template <typename> class boost_promise_handler_selector;

template <>
class boost_promise_handler_selector<void()>
  : public boost_promise_handler_0 {};

template <>
class boost_promise_handler_selector<void(boost::system::error_code)>
  : public boost_promise_handler_ec_0 {};

template <>
class boost_promise_handler_selector<void(std::exception_ptr)>
  : public boost_promise_handler_ex_0 {};

template <typename Arg>
class boost_promise_handler_selector<void(Arg)>
  : public boost_promise_handler_1<Arg> {};

template <typename Arg>
class boost_promise_handler_selector<void(boost::system::error_code, Arg)>
  : public boost_promise_handler_ec_1<Arg> {};

template <typename Arg>
class boost_promise_handler_selector<void(std::exception_ptr, Arg)>
  : public boost_promise_handler_ex_1<Arg> {};

#if defined(BOOST_ASIO_HAS_VARIADIC_TEMPLATES)

template <typename... Arg>
class boost_promise_handler_selector<void(Arg...)>
  : public boost_promise_handler_n<std::tuple<Arg...> > {};
...
class boost_promise_handler
  : public boost_promise_handler_selector<Signature>
{
public:
  typedef Allocator allocator_type;
  typedef void result_type;

  boost_promise_handler(use_boost_future_t<Allocator> u)
...
inline void asio_handler_invoke(Function& f,
    boost_promise_handler<Signature, Allocator>* h)
{
  typename boost_promise_handler<Signature, Allocator>::executor_type
    ex(h->get_executor());
...
public:
  ...
  explicit boost_promise_async_result(completion_handler_type& h)
...
{
public:
  boost_packaged_token(Function f, const Allocator& a)
...
class boost_packaged_handler
  : public boost_promise_creator<Result>
{
public:
  typedef Allocator allocator_type;
  typedef void result_type;
  ...
  void operator()(BOOST_ASIO_MOVE_ARG(Args)... args)
  {
    (boost_promise_invoke_and_set)(*this->p_,
  ...
  void operator()()
  {
    (boost_promise_invoke_and_set)(*this->p_, function_);
  }
...
inline void asio_handler_invoke(Function& f,
    boost_packaged_handler<Function1, Allocator, Result>* h)
{
  typename boost_packaged_handler<Function1, Allocator, Result>::executor_type
    ex(h->get_executor());
  ex.dispatch(BOOST_ASIO_MOVE_CAST(Function)(f), std::allocator<void>());
}
...
public:
  ...
  explicit boost_packaged_async_result(completion_handler_type& h)
    : future_(h.get_future())
  {
  }
...
{
  return detail::boost_packaged_token<typename decay<Function>::type, Allocator>(
...
class async_result<use_boost_future_t<Allocator>, Result(Args...)>
  : public detail::boost_promise_async_result<
      void(typename decay<Args>::type...), Allocator>
{
public:
  explicit async_result(
    typename detail::boost_promise_async_result<void(typename decay<Args>::type...),
      Allocator>::completion_handler_type& h)
    : detail::boost_promise_async_result<
...
public:
  explicit async_result(
    typename detail::boost_packaged_async_result<Function, Allocator,
...
public:
  explicit async_result(
    typename detail::boost_promise_async_result<
...
#define BOOST_ASIO_PRIVATE_ASYNC_RESULT_DEF(n) \
  ...
  class async_result<use_boost_future_t<Allocator>, \
  ...
  template <typename Function, typename Allocator, \
      typename Result, BOOST_ASIO_VARIADIC_TPARAMS(n)> \
  class async_result<detail::boost_packaged_token<Function, Allocator>, \
      Result(BOOST_ASIO_VARIADIC_TARGS(n))> \
    : public detail::boost_packaged_async_result<Function, Allocator, \
