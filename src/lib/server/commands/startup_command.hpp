...
class StartupCommand : public AbstractCommand {
 public:
  explicit StartupCommand(HyriseSession& session) : AbstractCommand(session), _state(StartupCommandState::Started) {}
 ...
 protected:
  enum class StartupCommandState { Started, SslDeniedSent, ExpectingStartupContent, AuthenticationStateSent };
