...
#define EXPLICIT_DECLARATION(r, template_class, type) extern template class template_class<type>; // NOLINT(bugprone-macro-parentheses)
...
#define EXPLICIT_INSTANTIATION(r, template_class, type) template class template_class<type>; // NOLINT(bugprone-macro-parentheses)
