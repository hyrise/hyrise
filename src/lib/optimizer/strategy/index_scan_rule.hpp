...
class IndexScanRule : public AbstractRule {
 ...
 protected:
  bool _is_index_scan_applicable(const IndexInfo& index_info, const std::shared_ptr<PredicateNode>& predicate_node, const std::shared_ptr<AbstractCostEstimator>& cost_estimator) const;
