...
private:
  ...
  void _top_down_traversal_visit(size_t current_node, std::vector<DipsPruningGraphEdge>& traversal_order, std::set<size_t>& visited);
  void _bottom_up_traversal_visit(size_t current_node, std::vector<DipsPruningGraphEdge>& traversal_order, std::set<size_t>& visited);
