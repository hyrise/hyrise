 ...
 *
 **/
static BetweenCompositionRule::ColumnBoundary BetweenCompositionRule::_get_boundary(
...
static BetweenCompositionRule::ColumnBoundary BetweenCompositionRule::_create_inverse_boundary(
