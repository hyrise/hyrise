...
MockNode::MockNode() : AbstractLogicalPlanNode(LQPNodeType::Mock) {}

MockNode::MockNode(const std::shared_ptr<TableStatistics>& statistics) : AbstractLogicalPlanNode(LQPNodeType::Mock) {
