...
MockNode::MockNode(const std::string& name, size_t column_count)
...
MockNode::MockNode(const std::shared_ptr<TableStatistics>& statistics, const std::string& name) : AbstractASTNode(ASTNodeType::Mock), _name(name) {
