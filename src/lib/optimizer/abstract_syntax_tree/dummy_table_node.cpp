...
const std::vector<std::string> &DummyTableNode::output_column_names() const {
...
optional<ColumnID> DummyTableNode::find_column_id_by_named_column_reference(const NamedColumnReference& named_column_reference) const {
  return {};
};
