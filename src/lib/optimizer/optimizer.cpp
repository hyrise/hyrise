...
std::shared_ptr<Optimizer> Optimizer::create_default_optimizer() {
  ...
  // This rule is currently under construction and, right now, doesn't combine well with our cardinality estimation implementation. For more accurate comparing results, it is therefore disabled.
