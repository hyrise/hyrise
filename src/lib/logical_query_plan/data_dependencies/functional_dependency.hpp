 ...
 *
 * Example A:
 * Think of a table with three columns: Course(Semester, CourseID, Lecturer). The primary key is defined across the
 * first two columns, which leads to the following FD:
