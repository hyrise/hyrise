...
CreateViewNode::CreateViewNode(const std::string& view_name, const AbstractLQPNodeCSPtr& lqp)
...
AbstractLQPNodeCSPtr CreateViewNode::lqp() const { return _lqp; }

AbstractLQPNodeSPtr CreateViewNode::_deep_copy_impl(
