...
/**
 * Calls the passed @param visitor on each node of the @param lqp. This will NOT visit sub_querys.
...
/**
 * @return The node @param lqp as well as the root nodes of all LQPs in sub_querys and, recursively, LQPs in their
 *         sub_querys
 */
