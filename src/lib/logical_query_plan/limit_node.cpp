...
LimitNode::LimitNode(const size_t num_rows, const std::shared_ptr<AbstractLQPNode>& left_child)
    : AbstractLQPNode(LQPNodeType::Limit, left_child), _num_rows(num_rows) {}
