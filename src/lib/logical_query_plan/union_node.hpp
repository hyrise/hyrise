...
class UnionNode : public AbstractLQPNode {
 public:
  explicit UnionNode(UnionMode union_mode, const std::shared_ptr<AbstractLQPNode>& left_child = nullptr, const std::shared_ptr<AbstractLQPNode>& right_child = nullptr);
