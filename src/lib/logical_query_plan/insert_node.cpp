...
InsertNode::InsertNode(const std::string table_name, const std::shared_ptr<AbstractLQPNode>& left_child)
    : AbstractLQPNode(LQPNodeType::Insert, left_child), _table_name(table_name) {}
