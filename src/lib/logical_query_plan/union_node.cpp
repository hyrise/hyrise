...
std::shared_ptr<AbstractLQPNode> UnionNode::_deep_copy_impl(const std::shared_ptr<AbstractLQPNode>& left_child, const std::shared_ptr<AbstractLQPNode>& right_child) const { return std::make_shared<UnionNode>(_union_mode); }
