...
DropColumnAction::DropColumnAction(const hsql::DropColumnAction init_alter_action)
    : AbstractAlterTableAction(init_alter_action), drop_column_action(init_alter_action) {
