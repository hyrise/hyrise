...
class GDSCache : public AbstractCacheEvictionPolicy<Key, Value> {
 public:
  ...
  explicit GDSCache(size_t capacity) : AbstractCacheEvictionPolicy<Key, Value>(capacity), _inflation(0.0) {}
