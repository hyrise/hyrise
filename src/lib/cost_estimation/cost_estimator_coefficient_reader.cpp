...
const CoefficientsPerGroup CostEstimatorCoefficientReader::read_join_coefficients(const std::string& file_path) {
  return {
      ...
      {ModelGroup{OperatorType::JoinMPSM, {}, false},
       {{"left_input_row_count", 63.364393027030154}, {"right_input_row_count", 43.876125771847164}}},
      {ModelGroup{OperatorType::JoinMPSM, {}, true},
       {{"left_input_row_count", 209.3998428455913}, {"right_input_row_count", 45.089003700911675}}},
