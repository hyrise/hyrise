...
extern const std::unordered_map<Logger::Implementation, std::string> logger_to_string;
extern const std::unordered_map<std::string, Logger::Implementation> string_to_logger;
