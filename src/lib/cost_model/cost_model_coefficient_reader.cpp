...
const CoefficientsPerGroup CostModelCoefficientReader::read_join_coefficients(const std::string& file_path) {
  return {{ModelGroup{OperatorType::JoinHash, {}, false},
           {{"left_input_row_count", 22.45190459223849},
                   {"right_input_row_count", 99.68893904977213}}},
          {ModelGroup{OperatorType::JoinHash, {}, true},
           {{"left_input_row_count", 31.493424340133515},
                   {"right_input_row_count", 79.3849625472923}}},
          {ModelGroup{OperatorType::JoinMPSM, {}, false},
                  {{"left_input_row_count", 63.364393027030154},
                          {"right_input_row_count", 43.876125771847164}}},
          {ModelGroup{OperatorType::JoinMPSM, {}, true},
                  {{"left_input_row_count", 209.3998428455913},
                          {"right_input_row_count", 45.089003700911675}}},
          {ModelGroup{OperatorType::JoinNestedLoop, {}, false},
           {{"left_input_row_count", 72.79503982648723},
                   {"right_input_row_count", 16.38312327057448}}},
          {ModelGroup{OperatorType::JoinNestedLoop, {}, true},
           {{"left_input_row_count", 1931.4930924059695},
                   {"right_input_row_count", 70.39852863077502}}},
          {ModelGroup{OperatorType::JoinSortMerge, {}, false},
           {{"left_input_row_count", 49.03427670959679},
                   {"right_input_row_count", 37.967034865681484}}},
          {ModelGroup{OperatorType::JoinSortMerge, {}, true},
           {{"left_input_row_count", 163.73846985773895},
                   {"right_input_row_count", 37.762080132353475}}},
          };
}
