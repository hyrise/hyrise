...
BinaryPredicateExpression::BinaryPredicateExpression(const PredicateCondition new_predicate_condition,
                                                     const std::shared_ptr<AbstractExpression>& left_operand,
                                                     const std::shared_ptr<AbstractExpression>& right_operand)
    : AbstractPredicateExpression(new_predicate_condition, {left_operand, right_operand}) {
#if HYRISE_DEBUG
