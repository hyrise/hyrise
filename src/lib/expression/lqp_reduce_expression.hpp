...
class LQPReduceExpression : public AbstractExpression {
 public:
  ...
  LQPReduceExpression(const std::shared_ptr<AbstractLQPNode>& init_reducer, const std::shared_ptr<AbstractExpression>& init_column, const DataType data_type);
  ...
  const std::shared_ptr<AbstractExpression> column;
