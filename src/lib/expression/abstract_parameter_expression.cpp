...
AbstractParameterExpression::AbstractParameterExpression(const ParameterExpressionType parameter_expression_type,
                                                         const ParameterID parameter_id)
    : AbstractExpression(ExpressionType::Parameter, {}),
      parameter_expression_type(parameter_expression_type),
