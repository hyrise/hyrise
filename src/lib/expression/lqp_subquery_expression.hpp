 ...
 * an LQP.
 *
 * The Parameters to an LQPSubqueryExpression are equivalent to the correlated parameters of a nested SELECT in SQL.
 ...
 * they are the `arguments` to the LQPSubqueryExpression.)
 *
