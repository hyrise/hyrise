...
BetweenExpression::BetweenExpression(const PredicateCondition new_predicate_condition,
    ...
    : AbstractPredicateExpression(new_predicate_condition, {value, lower_bound, upper_bound}) {
