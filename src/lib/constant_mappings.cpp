...
const Bimap<FunctionType, std::string> function_type_to_string{{{FunctionType::Substring, "SUBSTR"}, {FunctionType::Concatenate, "CONCAT"}}};
...
const Bimap<EncodingType, std::string> encoding_type_to_string{
...
const Bimap<TableType, std::string> table_type_to_string{{{TableType::Data, "Data"}, {TableType::References, "References"}}};
