...
const std::unordered_map<ExpressionType, std::string> expression_type_to_operator_string = {
    ...
    {ExpressionType::Equals, "="}, {ExpressionType::NotEquals, "!="},  {ExpressionType::LessThan, "<"},
    {ExpressionType::LessThanEquals, "<="}, {ExpressionType::GreaterThan, ">"}, {ExpressionType::GreaterThanEquals, ">="},
    {ExpressionType::Like, "LIKE"}, {ExpressionType::NotLike, "NOT LIKE"}, {ExpressionType::And, "AND"},
    {ExpressionType::Or, "OR"}, {ExpressionType::Between, "BETWEEN"}, {ExpressionType::Not, "NOT"},
};
