...
CREATE VIEW alias_view1 AS SELECT a AS x, b as y FROM id_int_int_int_100 WHERE a > 10; SELECT a, y FROM alias_view1;
CREATE VIEW alias_view2 AS SELECT a AS a1, a AS a2 FROM id_int_int_int_100 WHERE a > 10; SELECT a1, a2 FROM alias_view2;
