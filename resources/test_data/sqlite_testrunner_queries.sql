...
CREATE VIEW alias_view1 AS SELECT a AS a1, a AS a2 FROM id_int_int_int_100 WHERE a > 10; SELECT a1, a2 FROM alias_view1;
CREATE VIEW alias_view2 (a3, a4) AS SELECT a AS a1, a AS a2 FROM id_int_int_int_100 WHERE a > 10; SELECT a1, a2 FROM alias_view2; -- SELECT a3, a4 FROM alias_view2; #last_todo
