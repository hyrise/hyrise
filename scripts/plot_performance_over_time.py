...
if has_system_metrics:
    print("Note that the reported memory consumption is also affected by the (relatively high) amount needed to store that data. For TPC-H SF 1, this is around 30 MB.");
